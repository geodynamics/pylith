...
class App(GenerateMesh):
    ...
    def create_geometry(self):
        ...
        p7 = gmsh.model.geo.add_point(x1+0.5*lx, y1+0.5*ly, 0.0)
        p8 = gmsh.model.geo.add_point(x1+0.5*lx+0.5*ly*np.tan(theta), y1, 0.0)
        self.p_inter = p7
        ...
        self.c_yneg2 = gmsh.model.geo.add_line(p5, p8)
        self.c_yneg3 = gmsh.model.geo.add_line(p8, p2)
        ...
        self.c_xcenter1 = gmsh.model.geo.add_line(p5, p7)
        self.c_xcenter2 = gmsh.model.geo.add_line(p7, p6)
        self.c_fault2 = gmsh.model.geo.add_line(p8, p7)
        ...
        c0 = gmsh.model.geo.add_curve_loop([self.c_yneg1, self.c_xcenter1, self.c_xcenter2,self.c_ypos1, self.c_xneg])
        self.s_xneg = gmsh.model.geo.add_plane_surface([c0])
        c1 = gmsh.model.geo.add_curve_loop([self.c_yneg2, self.c_fault2, -self.c_xcenter1])
        self.s_xpos1 = gmsh.model.geo.add_plane_surface([c1])
        c2 = gmsh.model.geo.add_curve_loop([self.c_yneg3, self.c_xpos, self.c_ypos2, -self.c_xcenter2,-self.c_fault2])
        self.s_xpos2 = gmsh.model.geo.add_plane_surface([c2])
    ...
    def generate_mesh(self, cell):
        ...
        gmsh.model.mesh.field.setNumbers(field_distance, "CurvesList", [self.c_xcenter1,self.c_xcenter2,self.c_fault2])
