...
class App(GenerateMesh):
    ...
    def create_geometry(self):
        ...
        self.c_inflow = gmsh.model.geo.add_line(p5,p6)
        self.c_yneg2 = gmsh.model.geo.add_line(p6, p2)
    ...
    def mark(self):
        ...
        vertex_groups = (
            ...
            VertexGroup(name="boundary_yneg", tag=12, dim=1, entities=[self.c_yneg1, self.c_inflow, self.c_yneg2]),
            VertexGroup(name="boundary_ypos", tag=13, dim=1, entities=[self.c_ypos]),
            VertexGroup(name="inflow", tag=20, dim=1, entities=[self.c_inflow]),
        )
