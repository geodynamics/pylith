#!/usr/bin/env nemesis
"""Generate text file with list of fake GNSS stations for Steps 4 and 5.

Command line arguments control the number of stations, distance, and random distribution.

The default values will generate the `gnss_stations.txt` file that is provided.
"""
...
class App:
    """Application for generating list of fake GNSS stations.
    """
    ...
    def __init__(self):
        ...
        self.filename = "gnss_stations.txt"
    ...
    def create_points(self):
        """Create random points for fake GNSS stations.
        """
    ...
    def write(self, points):
        """Write fake GNSS stations to text file used by PyLith `OuputSolnPoints`.

        :param points: Numpy array (npoints, 2) with coordinates of stations.
        """
        with open(self.filename, "w") as fout:
            fout.write("# List of GNSS stations generated by `generate_gnssstations.py` Python script.\n")
            st_id = 1
