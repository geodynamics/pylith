...
\subsection{Step 5: Spontaneous Earthquakes With Rate-State Friction}
...
\item Adjust the friction model parameters and examine the effects on
    the deformation and the convergence of the nonlinear solve.
\end{itemize}
