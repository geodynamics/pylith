...
function of time. Additional to illustrate PyLith's ability to use
...
You will notice that the \filename{spatialdb} does not contain the
\filename{fault\_slabtop\_slowslip.spatialdb} and
...
as an illustration of how to use Python to generate more somple
...
coordinate system for the fake cGPS stations,
