...
\important{{\em All} declarations of class methods must include a
...
\item[PYLITH\_JOURNAL\_DEBUG] Use this macro immediate after
  PYLITH\_METHOD\_BEGIN in methods of all objects that inherit from \object{GenericComponent}.
\item[PYLITH\_COMPONENT\_DEBUG] Use this macro immediate after
  ...
  \object{PyreComponent::name()} in the constructor. We recommend
