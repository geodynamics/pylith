...
\begin{tikzpicture}[node distance=25.0em, line width=1.5pt]
  ...
  % repositories
  \node (geodynamics-github) [github] {GitHub\\[4pt] upstream\\[4pt] {\tt geodynamics/pylith}};
  \node (developer-github) [github, right of=geodynamics-github] {GitHub\\[4pt] origin\\[4pt] {\tt saradeveloper/pylith}};
  \node (developer-computer) [local, right of=developer-github] {Local Computer\\[4pt] {\tt saradeveloper/pylith}};
