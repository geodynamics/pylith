...
\matt{(Comment from Brad) We need a mechanism to formulate this
  diagonal mass matrix without allocating the sparse matrix. In other
  words, we need a lumping version of DMPlexComputeJacobian\_Internal().}
