...
The range of deformation for a porous medium is defined by two limiting regimes,
...
\begin{inventory}
  ...
  \propertyitem{update\_fields}{Determine change in auxiliary variables at the end of
    each iteration. Currently only implemented for porosity, and shifts the quasistatic
