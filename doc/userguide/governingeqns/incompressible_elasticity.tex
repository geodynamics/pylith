...
In this section we apply the same approach we use for the elasticity
equation to the case of an incompressible material. As the bulk
modulus ($K$) approaches infinity, the volumetric strain
