...
#include "pylith/materials/IsotropicLinearMaxwell3D.hh" // implementation of object methods
...
#include "pylith/fekernels/IsotropicLinearMaxwell3D.hh" // USES IsotropicLinearMaxwell3D kernels
...
// ----------------------------------------------------------------------
const char* pylith::materials::IsotropicLinearMaxwell3D::_pyreComponent = "isotropiclinearmaxwell3d";

// ----------------------------------------------------------------------
// Default constructor.
pylith::materials::IsotropicLinearMaxwell3D::IsotropicLinearMaxwell3D(void) :
...
// ----------------------------------------------------------------------
// Destructor.
pylith::materials::IsotropicLinearMaxwell3D::~IsotropicLinearMaxwell3D(void) {} // destructor


// ----------------------------------------------------------------------
// Include inertia?
void
pylith::materials::IsotropicLinearMaxwell3D::useInertia(const bool value) {
...
// Include inertia?
bool
pylith::materials::IsotropicLinearMaxwell3D::useInertia(void) const {
    return _useInertia;
} // useInertia
...
// Include body force?
void
pylith::materials::IsotropicLinearMaxwell3D::useBodyForce(const bool value) {
...
// Include body force?
bool
pylith::materials::IsotropicLinearMaxwell3D::useBodyForce(void) const {
...
// strain?
void
pylith::materials::IsotropicLinearMaxwell3D::useReferenceState(const bool value) {
...
// strain?
bool
pylith::materials::IsotropicLinearMaxwell3D::useReferenceState(void) const {
...
void
pylith::materials::IsotropicLinearMaxwell3D::verifyConfiguration(const pylith::topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
    PYLITH_COMPONENT_DEBUG("verifyConfiguration(solution="<<solution.label()<<")");

    // Verify solution contains expected fields.
    if (!solution.hasSubfield("displacement")) {
        throw std::runtime_error("Cannot find 'displacement' field in solution; required for material 'IsotropicLinearMaxwell3D'.");
    } // if
    if (_useInertia && !solution.hasSubfield("velocity")) {
        throw std::runtime_error("Cannot find 'velocity' field in solution; required for material 'IsotropicLinearMaxwell3D' with inertia.");
    } // if
...
void
pylith::materials::IsotropicLinearMaxwell3D::_auxFieldSetup(void) {
    PYLITH_METHOD_BEGIN;
    ...
    _updateStateVarsKernels["viscous_strain"] = pylith::fekernels::IsotropicLinearMaxwell3D::updateViscousStrain;
    _updateStateVarsKernels["total_strain"] = pylith::fekernels::IsotropicLinearMaxwell3D::updateTotalStrain;
...
void
pylith::materials::IsotropicLinearMaxwell3D::_setFEConstants(const pylith::topology::Field& solution,
...
void
pylith::materials::IsotropicLinearMaxwell3D::_setFEKernelsRHSResidual(const pylith::topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
    ...
    if (!solution.hasSubfield("velocity")) {
        // Displacement
        const PetscPointFunc g0u = (_gravityField && _useBodyForce) ? pylith::fekernels::IsotropicLinearMaxwell3D::g0v_gravbodyforce :
                                   (_gravityField) ? pylith::fekernels::IsotropicLinearMaxwell3D::g0v_grav :
                                   (_useBodyForce) ? pylith::fekernels::IsotropicLinearMaxwell3D::g0v_bodyforce :
                                   NULL;
        const PetscPointFunc g1u = (!_useReferenceState) ? pylith::fekernels::IsotropicLinearMaxwell3D::g1v : pylith::fekernels::IsotropicLinearMaxwell3D::g1v_refstate;
        ...
        // Velocity
        const PetscPointFunc g0v = (_gravityField && _useBodyForce) ? pylith::fekernels::IsotropicLinearMaxwell3D::g0v_gravbodyforce :
                                   (_gravityField) ? pylith::fekernels::IsotropicLinearMaxwell3D::g0v_grav :
                                   (_useBodyForce) ? pylith::fekernels::IsotropicLinearMaxwell3D::g0v_bodyforce :
                                   NULL;
        const PetscPointFunc g1v = (!_useReferenceState) ? pylith::fekernels::IsotropicLinearMaxwell3D::g1v : pylith::fekernels::IsotropicLinearMaxwell3D::g1v_refstate;
...
void
pylith::materials::IsotropicLinearMaxwell3D::_setFEKernelsRHSJacobian(const pylith::topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
    ...
    if (!solution.hasSubfield("velocity")) {
        ...
        const PetscPointJac Jg3uu = pylith::fekernels::IsotropicLinearMaxwell3D::Jg3vu;
        ...
        const PetscPointJac Jg3vu = pylith::fekernels::IsotropicLinearMaxwell3D::Jg3vu;
...
void
pylith::materials::IsotropicLinearMaxwell3D::_setFEKernelsLHSResidual(const pylith::topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
...
void
pylith::materials::IsotropicLinearMaxwell3D::_setFEKernelsLHSJacobian(const pylith::topology::Field& solution) const {
    PYLITH_METHOD_BEGIN;
