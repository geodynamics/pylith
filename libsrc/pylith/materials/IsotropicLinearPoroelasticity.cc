...
// ---------------------------------------------------------------------------------------------------------------------
// Default constructor.
pylith::materials::IsotropicLinearPoroelasticity::IsotropicLinearPoroelasticity(void) : _auxiliaryFactory(new pylith::materials::AuxiliaryFactoryPoroelastic),
...
void pylith::materials::IsotropicLinearPoroelasticity::deallocate(void)
{
...
void pylith::materials::IsotropicLinearPoroelasticity::useReferenceState(const bool value)
{
...
// ---------------------------------------------------------------------------------------------------------------------
// Use reference stress and strain in computation of stress and strain?
bool pylith::materials::IsotropicLinearPoroelasticity::useReferenceState(void) const
{
...
void pylith::materials::IsotropicLinearPoroelasticity::useTensorPermeability(const bool value)
{
...
// ---------------------------------------------------------------------------------------------------------------------
// Use full tensor permeability?
bool pylith::materials::IsotropicLinearPoroelasticity::useTensorPermeability(void) const
{
...
void pylith::materials::IsotropicLinearPoroelasticity::addAuxiliarySubfields(void)
{
    PYLITH_METHOD_BEGIN;
                                                               ...
                                                               const bool _useSourceDensity) const
{
    ...
    {
    case 0x0:
        g0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g0p : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g0p
                                                                                                          : NULL;
        break;
    case 0x1:
        g0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g0p : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g0p
    ...
    case 0x2:
        ...
        break;
    case 0x4:
        g0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g0p_source : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g0p_source
    ...
    case 0x3:
        ...
        break;
    case 0x5:
        g0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g0p_source_body : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g0p_source_body
                                                                                                                      : NULL; // aOff for sourceDensity is 4
        break;
    case 0x6:
        g0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g0p_source_grav : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g0p_source_grav
                                                                                                                      : NULL; // aOff for sourceDensity is 4
        break;
    case 0x7:
        g0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g0p_source_grav_body : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g0p_source_grav_body
                                                                        ...
                                                                        const bool _gravityField) const
{
    ...
    {
    case 0x0:
        g1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g1p : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g1p
                                                                                                          : NULL;
        break;
    case 0x1:
        g1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g1p_tensor_permeability : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g1p_tensor_permeability
                                                                                                                              : NULL;
        break;
    case 0x2:
        g1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g1p_gravity : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g1p_gravity
                                                                                                                  : NULL;
        break;
    case 0x3:
        g1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g1p_gravity_tensor_permeability : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g1p_gravity_tensor_permeability
                                                                                                                                      : NULL;
        break;
    default:
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelg1v_explicit(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    {
    case 0x0:
        g1v = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g1v : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g1v
                                                                                                          : NULL;
        break;
    case 0x1:
        g1v = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::g1v_refstate : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::g1v_refstate
                                                                                                                   : NULL;
        break;
    default:
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelf0p_explicit(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointFunc f0p =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_explicit : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_explicit
                                                                                                             : NULL;
                                                                        ...
                                                                        const bool _useSourceDensity) const
{
    ...
    {
    case 0x0:
        f0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_implicit : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_implicit
                                                                                                                   : NULL;
        break;
    case 0x1:
        f0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_implicit : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_implicit
    ...
    case 0x2:
        ...
        break;
    case 0x4:
        f0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_implicit_source : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_implicit_source
                                                                                                                          : NULL; // aOff for sourceDensity is 3
        break;
    case 0x3:
        f0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_implicit : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_implicit
        ...
        break;
    case 0x5:
        f0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_implicit_source_body : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_implicit_source_body
                                                                                                                               : NULL; // aOff for sourceDensity is 4
        break;
    case 0x6:
        f0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_implicit_source_grav : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_implicit_source_grav
                                                                                                                               : NULL; // aOff for sourceDensity is 4
        break;
    case 0x7:
        f0p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f0p_implicit_source_grav_body : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f0p_implicit_source_grav_body
                                                                                                                                    : NULL; // aOff for sourceDensity is 5
        break;
    default:
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelf1u_implicit(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    {
    case 0x0:
        f1u = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1u : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1u
                                                                                                          : NULL;
        break;
    case 0x1:
        f1u = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1u_refstate : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1u_refstate
                                                                                                                   : NULL;
        break;
    default:
                                                                        ...
                                                                        const bool _gravityField) const
{
    ...
    {
    case 0x0:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p
                                                                                                          : NULL;
        break;
    case 0x1:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p_tensor_permeability : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p_tensor_permeability
                                                                                                                              : NULL;
        break;
    case 0x2:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p_body : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p_body
                                                                                                               : NULL;
        break;
    case 0x3:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p_body_tensor_permeability : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p_body_tensor_permeability
                                                                                                                                   : NULL;
        break;
    case 0x4:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p_gravity : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p_gravity
                                                                                                                  : NULL;
        break;
    case 0x5:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p_gravity_tensor_permeability : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p_gravity_tensor_permeability
                                                                                                                                      : NULL;
        break;
    case 0x6:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p_body_gravity : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p_body_gravity
                                                                                                                       : NULL;
        break;
    case 0x7:
        f1p = (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::f1p_body_gravity_tensor_permeability : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::f1p_body_gravity_tensor_permeability
                                                                                                                                           : NULL;
        break;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf3uu(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf3uu =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf3uu : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf3uu
                                                                                                      : NULL;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf2up(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf2up =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf2up : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf2up
                                                                                                      : NULL;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf2ue(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf2ue =
        (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf2ue : (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf2ue
                                                                                                               : NULL;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf0pp(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf0pp =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf0pp : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf0pp
                                                                                                      : NULL;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf3pp(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf3pp =
        (!_useTensorPermeability && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf3pp : (!_useTensorPermeability && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf3pp
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf0pe(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jf0pe =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf0pe : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf0pe
                                                                                                      : NULL;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf0ppdot(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointJac Jf0ppdot =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf0ppdot : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf0ppdot
                                                                                                         : NULL;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelJf0pedot(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointJac Jf0pedot =
        (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::Jf0pedot : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::Jf0pedot
                                                                                                         : NULL;
...
pylith::materials::IsotropicLinearPoroelasticity::getKernelDerivedCauchyStress(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc kernel =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::cauchyStress : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::cauchyStress
...
void pylith::materials::IsotropicLinearPoroelasticity::updateKernelConstants(pylith::real_array *kernelConstants,
...
void pylith::materials::IsotropicLinearPoroelasticity::addKernelsUpdateStateVarsImplicit(std::vector<ProjectKernels> *kernels,
                                                                                         ...
                                                                                         const bool _useStateVars) const
{
    ...
    if (_useStateVars)
    {
        ...
        const PetscPointFunc funcPorosity =
            (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::updatePorosityImplicit : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::updatePorosityImplicit
                                                                                                                           : NULL;
...
void pylith::materials::IsotropicLinearPoroelasticity::addKernelsUpdateStateVarsExplicit(std::vector<ProjectKernels> *kernels,
                                                                                         const spatialdata::geocoords::CoordSys *coordsys,
                                                                                         const bool _useStateVars) const
{
    PYLITH_METHOD_BEGIN;
    ...
    if (_useStateVars)
    {
        ...
        const PetscPointFunc funcPorosity =
            (3 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticity3D::updatePorosityExplicit : (2 == spaceDim) ? pylith::fekernels::IsotropicLinearPoroelasticityPlaneStrain::updatePorosityExplicit
                                                                                                                           : NULL;
