...
/** @file libsrc/materials/IsotropicLinearGenMaxwell3D.hh
 *
 * @brief C++ class for isotropic linear Generalized Maxwell viscoelastic 3D material.
 */

#if !defined(pylith_materials_isotropiclineargenmaxwell3d_hh)
#define pylith_materials_isotropiclineargenmaxwell3d_hh
...
class pylith::materials::IsotropicLinearGenMaxwell3D : public pylith::materials::Material { // class IsotropicLinearGenMaxwell3D
    friend class TestIsotropicLinearGenMaxwell3D;   // unit testing

    // PUBLIC METHODS /////////////////////////////////////////////////////
public:

    /// Default constructor.
    IsotropicLinearGenMaxwell3D(void);
...
private:
    ...
    IsotropicLinearGenMaxwell3D(const IsotropicLinearGenMaxwell3D&);   ///< Not implemented.
    const IsotropicLinearGenMaxwell3D& operator=(const IsotropicLinearGenMaxwell3D&);   ///< Not implemented

}; // class IsotropicLinearGenMaxwell3D

#endif // pylith_materials_isotropiclineargenmaxwell3d_hh
