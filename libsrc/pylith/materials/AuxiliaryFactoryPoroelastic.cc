...
void pylith::materials::AuxiliaryFactoryPoroelastic::addIsotropicPermeability(void)
...
// ----------------------------------------------------------------------------
// Add isotropic permeability subfield to auxiliary fields.
void pylith::materials::AuxiliaryFactoryPoroelastic::addTensorPermeability(void)
{ // isotropicPermeablity
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryPoroelastic::addDrainedBulkModulus(void)
{ // DrainedBulkModulus
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryPoroelastic::addBiotCoefficient(void)
{ // biotCoefficient
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryPoroelastic::addBiotModulus(void)
{ // biotCoefficient
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryPoroelastic::addReferenceStress(void)
{ // referenceStress
    PYLITH_METHOD_BEGIN;
    ...
    const char *componentNames[6] = {
        ...
        "reference_stress_yz",
        "reference_stress_xz"};
    const int stressSize = (3 == _spaceDim) ? 6 : (2 == _spaceDim) ? 4
                                                                   : 1;
    const PylithReal pressureScale = _normalizer->getPressureScale();
...
void pylith::materials::AuxiliaryFactoryPoroelastic::addReferenceStrain(void)
{ // addReferenceStrain
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::AuxiliaryFactoryPoroelastic::addShearModulus(void)
{
    PYLITH_METHOD_BEGIN;
