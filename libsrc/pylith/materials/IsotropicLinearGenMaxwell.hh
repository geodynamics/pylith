...
public:
     ...
     */
    PetscPointFunc getKernelLHSResidualStress(const spatialdata::geocoords::CoordSys* coordsys) const;
     ...
     */
    PetscPointJac getKernelLHSJacobianElasticConstants(const spatialdata::geocoords::CoordSys* coordsys) const;
