...
void pylith::materials::IsotropicSelfGravElasticity::deallocate(void)
{
    RheologySelfGravElasticity::deallocate();
...
void pylith::materials::IsotropicSelfGravElasticity::useReferenceState(const bool value)
{
...
// ------------------------------------------------------------------------------------------------
// Use reference stress and strain in computation of stress and strain?
bool pylith::materials::IsotropicSelfGravElasticity::useReferenceState(void) const
{
...
void pylith::materials::IsotropicSelfGravElasticity::addAuxiliarySubfields(void)
{
    PYLITH_METHOD_BEGIN;
...
pylith::materials::IsotropicSelfGravElasticity::getKernelf0p(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc f0p = pylith::fekernels::IsotropicSelfGravElasticity::f0p;
...
pylith::materials::IsotropicSelfGravElasticity::getKernelf1u(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointFunc f1u =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicSelfGravElasticity3D::f1u_infinitesimalStrain : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicSelfGravElasticityPlaneStrain::f1u_infinitesimalStrain
...
PetscPointFunc
pylith::materials::IsotropicSelfGravElasticity::getKernelf1p(const spatialdata::geocoords::CoordSys *coordsys) const
{
    PYLITH_METHOD_BEGIN;
    PYLITH_COMPONENT_DEBUG("getKernelf1p(coordsys=" << typeid(coordsys).name() << ")");
...
pylith::materials::IsotropicSelfGravElasticity::getKernelJf3uu(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    const int spaceDim = coordsys->getSpaceDim();
    PetscPointJac Jg3uu =
        (3 == spaceDim) ? pylith::fekernels::IsotropicSelfGravElasticity3D::Jf3uu_infinitesimalStrain : (2 == spaceDim) ? pylith::fekernels::IsotropicSelfGravElasticityPlaneStrain::Jf3uu_infinitesimalStrain
                                                                                                                        : NULL;
...
PetscPointJac
pylith::materials::IsotropicSelfGravElasticity::getKernelJf3pp(const spatialdata::geocoords::CoordSys *coordsys) const
{
    PYLITH_METHOD_BEGIN;
    PYLITH_COMPONENT_DEBUG("getKernelJf3pp(coordsys=" << typeid(coordsys).name() << ")");

    PetscPointJac Jf3pp = pylith::fekernels::IsotropicSelfGravElasticity::Jf3pp;
...
pylith::materials::IsotropicSelfGravElasticity::getKernelCauchyStressVector(const spatialdata::geocoords::CoordSys *coordsys) const
{
    ...
    PetscPointFunc kernel =
        (!_useReferenceState && 3 == spaceDim) ? pylith::fekernels::IsotropicSelfGravElasticity3D::cauchyStress_infinitesimalStrain_asVector : (!_useReferenceState && 2 == spaceDim) ? pylith::fekernels::IsotropicSelfGravElasticityPlaneStrain::cauchyStress_infinitesimalStrain_asVector
