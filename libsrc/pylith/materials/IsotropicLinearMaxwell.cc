...
PetscBdPointFunc
pylith::materials::IsotropicLinearMaxwell::getKernelF0lNeg(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
...
PetscBdPointFunc
pylith::materials::IsotropicLinearMaxwell::getKernelF0lPos(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
...
PetscBdPointJac
pylith::materials::IsotropicLinearMaxwell::getKernelJf1luNeg(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
...
PetscBdPointJac
pylith::materials::IsotropicLinearMaxwell::getKernelJf1luPos(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
