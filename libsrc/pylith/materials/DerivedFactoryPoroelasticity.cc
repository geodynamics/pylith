...
void pylith::materials::DerivedFactoryPoroelasticity::addCauchyStress(void)
{
    PYLITH_METHOD_BEGIN;
...
void pylith::materials::DerivedFactoryPoroelasticity::addCauchyStrain(void)
{
    PYLITH_METHOD_BEGIN;
...
// ---------------------------------------------------------------------------------------------------------------------
// Add Cauchy (infinitesimal) strain subfield to derived fields.
void pylith::materials::DerivedFactoryPoroelasticity::addOutputPorosity(void)
{
    PYLITH_METHOD_BEGIN;
    PYLITH_JOURNAL_DEBUG("addOutputPorosity(void)");
...
void pylith::materials::DerivedFactoryPoroelasticity::addSubfields(void)
{
    PYLITH_METHOD_BEGIN;
    ...
    if (_subfieldDiscretizations.find("porosity") != _subfieldDiscretizations.end())
    {
        addOutputPorosity();
    } // if
