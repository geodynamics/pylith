...
PetscBdPointFunc
pylith::materials::IsotropicPowerLaw::getKernelF0lNeg(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
...
PetscBdPointFunc
pylith::materials::IsotropicPowerLaw::getKernelF0lPos(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
...
PetscBdPointJac
pylith::materials::IsotropicPowerLaw::getKernelJf1luNeg(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
...
PetscBdPointJac
pylith::materials::IsotropicPowerLaw::getKernelJf1luPos(const spatialdata::geocoords::CoordSys* coordsys) const {
    PYLITH_METHOD_BEGIN;
