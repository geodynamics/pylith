...
#if !defined(pylith_faults_fieldops_hh)
#define pylith_faults_fieldops_hh

// Include directives ---------------------------------------------------
#include "pylith/faults/faultsfwd.hh" // forward declarations

#include "pylith/problems/problemsfwd.hh" // USES IntegrationData
...
public:
     ...
     */
    static
    void createDAEMassWeighting(pylith::problems::IntegrationData* integrationData,
     ...
     */
    static
    void updateDAEMassWeighting(pylith::problems::IntegrationData* integrationData);
