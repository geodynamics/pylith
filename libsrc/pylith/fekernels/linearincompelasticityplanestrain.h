...
#if !defined(pylith_fekernels_linearincompelasticityplanestrain_h)
#define pylith_fekernels_linearincompelasticityplanestrain_h
...
#endif /* pylith_fekernels_linearincompelasticityplanestrain_h */
