...
/** @file libsrc/fekernels/IsotropicLinearGenMaxwell3D.hh
 *
 * Kernels for linear Generalized Maxwell viscoelastic 3d
 * with 3 Maxwell elements.
 *
 * Solution fields: [disp(dim), vel(dim, optional)]
 *
 * Isotropic, linear Generalized Maxwell viscoelastic 3D without reference stress/strain.
 * Auxiliary fields:
 * - 0: density(1)
 * - 1: shear_modulus(1)
 * - 2: bulk_modulus(1)
 ...
 * - 5: viscous_strain(18) (vis_strain_1_xx, etc.)
 * - 6: total_strain(6)
 * - 7: gravity_field (3, optional)
 * - 8: body_force(3,optional)
 * - 9: reference_stress(6,optional) (stress_xx, stress_yy, stress_zz, stress_xy, stress_yz, stress_xz)
 * -10: reference_strain(6,optional) (strain_xx, strain_yy, strain_zz, strain_xy, strain_yz, strain_xz)
 *
...
#if !defined(pylith_fekernels_isotropiclineargenmaxwell3d_hh)
#define pylith_fekernels_isotropiclineargenmaxwell3d_hh
...
public:
    ...
    /** g0 function for isotropic linear Generalized Maxwell 3D with both gravity and body forces.
     *
     * Solution fields: [...]
    ...
    /** g0 function for isotropic linear generalized Maxwell 3D with gravity.
     *
     * Solution fields: [...]
     * Auxiliary fields: [0: density(1),
     *                    1: shear_modulus(1),
    ...
    /** g0 function for isotropic linear generalized Maxwell 3D with body forces.
     *
     * Solution fields: [...]
     * Auxiliary fields: [0: density(1),
     *                    1: shear_modulus(1),
...
#endif // pylith_fekernels_isotropiclineargenmaxwell3d_hh
