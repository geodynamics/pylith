...
class App(GenerateMesh):
    ...
    def _add_arguments(parser):
        parser.add_argument(
            ...
            type=int,
            default=0,
            help="Level of refinement on faults.",
        )
    ...
    def generate_mesh(self, cell):
        ...
        gmsh.model.mesh.field.setNumber(field_distance, "Sampling", 40)
