...
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c
c...  Program segment to define material model 16:
c
c       Model number:                      16
c       Model name:                        ??
...
c                                          ??
c
      subroutine mat_prt_16(prop,nprop,matnum,idout,idsk,kw,kp,
     & ierr,errstrng)
c
c...  subroutine to output material properties for material model 16.
c
c     Error codes:
c         4:  Write error
...
c
c
      subroutine elas_mat_16(dmat,prop,iddmat,nprop,ierr,errstrng)
c
...
c
c
      subroutine elas_strs_16(state,ee,dmat,nstate,ierr,errstrng)
c
...
c
c
      subroutine td_matinit_16(state,dstate,dmat,prop,rtimdat,rgiter,
...
c
c
      subroutine td_strs_16(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine td_strs_mat_16(state,dstate,ee,dmat,prop,rtimdat,
...
c
c
      subroutine prestr_mat_16(dmat,prop,autofac,iddmat,nprop,ierr,
     & errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c
      ...
      call elas_mat_16(dmat,ptmp,iddmat,nprop,ierr,errstrng)
      return
      end
c       

c version
c $Id: mat_16.f,v 1.4 2005/01/18 19:48:51 willic3 Exp $
