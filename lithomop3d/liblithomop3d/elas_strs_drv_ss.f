...
c
     ...
     & state,dmat,ien,lm,lmx,lmf,infiel,nstatesz,ndmatsz,numelt,nconsz, ! elemnt
     & infmat,numat,                                                    ! materl
...
c
      integer numnp,neq,numfn,numslp,nstatesz,ndmatsz,numelt,nconsz
      integer numat,numrot,ierr
...
c
c version
c $Id: elas_strs_drv_ss.f,v 1.3 2004/06/21 20:50:31 willic3 Exp $
c
