...
c
c
      subroutine elas_strs_8(state,ee,dmat,nstate,ierr,errstrng)
c
...
c
c
      subroutine td_matinit_8(state,dstate,dmat,prop,rtimdat,rgiter,
...
c
c
      subroutine td_strs_8(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine td_strs_mat_8(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine prestr_mat_8(dmat,prop,autofac,iddmat,nprop,ierr,
     & errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c version
c $Id: mat_8.f,v 1.4 2005/01/18 19:42:53 willic3 Exp $
