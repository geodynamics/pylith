...
c
     ...
     &     infmat(1,imat),matgpt,elasstrs1,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs2,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs3,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs4,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs5,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs6,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs7,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs8,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs9,                             ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs10,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs11,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs12,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs13,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs14,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs15,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs16,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs17,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs18,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs19,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
     ...
     &     state,dmat,ien,lm,lmx,lmf,infiel,nstr,nddmat,nstatesz,       ! elemnt
     &     ndmatsz,numelt,nconsz,                                       ! elemnt
     &     infmat(1,imat),matgpt,elasstrs20,                            ! materl
     &     gauss,sh,shj,infetype,netypes,ngaussmax,nenmax,              ! eltype
     &     skew,nskdim,numrot,                                          ! skew
     &     getshape,bmatrix,idebug,idout,kto,kw,ierr)                   ! info
        else
...
c
c version
c $Id: elasstrssdrv.f,v 1.2 2004/05/25 17:39:53 willic3 Exp $
c
