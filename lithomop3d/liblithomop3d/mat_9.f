...
c
     ...
     & ierr,errstrng)
c
c...  subroutine to output material properties for material model 9.
c
c     Error codes:
c         4:  Write error
...
c
c
      subroutine elas_mat_9(dmat,prop,iddmat,nprop,ierr,errstrng)
c
...
c
c
      subroutine elas_strs_9(state,ee,dmat,nstate,ierr,errstrng)
c
...
c
c
      subroutine td_matinit_9(state,dstate,dmat,prop,rtimdat,rgiter,
...
c
c
      subroutine td_strs_9(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine td_strs_mat_9(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine prestr_mat_9(dmat,prop,autofac,iddmat,nprop,ierr,
     & errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c
      ...
      call elas_mat_9(dmat,ptmp,iddmat,nprop,ierr,errstrng)
      return
      end
c       

c version
c $Id: mat_9.f,v 1.4 2005/01/18 19:43:40 willic3 Exp $
