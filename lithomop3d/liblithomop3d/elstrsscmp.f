...
c
c
      subroutine elstrsscmp(x,b,d,dx,tfault,nsd,ndof,numnp,neq,numfn,
     & numslp,
...
c
      ...
      integer ndmatsz,numelt,nconsz,netypes,nskdim,numrot
...
c
        do l=1,ngauss
          ...
          inddmatg=inddmat+(l-1)*nstate
          call elasstrs(state(1,indstateg),ee(nstr*(l-1)),
     &     dmat(inddmatg),nstr,nstate,nddmat)
...
c
c version
c $Id: elstrsscmp.f,v 1.1 2004/05/20 21:07:35 willic3 Exp $
c
