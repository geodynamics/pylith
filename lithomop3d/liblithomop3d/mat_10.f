...
c
c
      subroutine elas_strs_10(state,ee,dmat,nstate,ierr,errstrng)
c
...
c
c
      subroutine td_strs_10(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine td_strs_mat_10(state,dstate,ee,dmat,prop,rtimdat,
...
c
c
      subroutine prestr_mat_10(dmat,prop,autofac,iddmat,nprop,ierr,
     & errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c version
c $Id: mat_10.f,v 1.4 2005/01/18 19:44:28 willic3 Exp $
