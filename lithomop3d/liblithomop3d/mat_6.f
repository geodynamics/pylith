...
c
c
      subroutine elas_strs_6(state,ee,dmat,nstate,ierr,errstrng)
c
...
c
c
      subroutine td_matinit_6(state,dstate,dmat,prop,rtimdat,rgiter,
...
c
c
      subroutine td_strs_6(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine td_strs_mat_6(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine prestr_mat_6(dmat,prop,autofac,iddmat,nprop,ierr,
     & errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c version
c $Id: mat_6.f,v 1.4 2005/01/18 19:41:19 willic3 Exp $
