...
c
     ...
     & nen,nsd,ndof,nstr,ngauss,ierr,getshape,bmatrix)
c
...
cdebug      integer idb,jdb
      integer l,i,nee
      double precision shd(4,nenmax,ngaussmax),b(6,60),shbar(4,20),vol
c
...
c
cdebug      write(6,*) "Hello from bdeldss_f!"
c
      nee=ndof*nen
...
c
c version
c $Id: bdeldss.f,v 1.1 2004/04/14 21:18:30 willic3 Exp $
c
