...
c
c
      subroutine elas_strs_7(state,ee,dmat,nstate,ierr,errstrng)
c
...
c
c
      subroutine td_matinit_7(state,dstate,dmat,prop,rtimdat,rgiter,
...
c
c
      subroutine td_strs_7(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine td_strs_mat_7(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine prestr_mat_7(dmat,prop,autofac,iddmat,nprop,ierr,
     & errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c version
c $Id: mat_7.f,v 1.4 2005/01/18 19:42:05 willic3 Exp $
