...
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c
c...  Program segment to define material model 18:
c
c       Model number:                      18
c       Model name:                        ??
...
c                                          ??
c
      subroutine mat_prt_18(prop,nprop,matnum,idout,idsk,kw,kp,
     & ierr,errstrng)
c
c...  subroutine to output material properties for material model 18.
c
c     Error codes:
c         4:  Write error
...
c
c
      subroutine elas_mat_18(dmat,prop,iddmat,nprop,ierr,errstrng)
c
...
c
c
      subroutine elas_strs_18(state,ee,dmat,nstate,ierr,errstrng)
c
...
c
c
      subroutine td_matinit_18(state,dstate,dmat,prop,rtimdat,rgiter,
...
c
c
      subroutine td_strs_18(state,dstate,ee,dmat,prop,rtimdat,rgiter,
     & ntimdat,iddmat,tmax,nstate,nprop,matchg,ierr,errstrng)
c
...
c
c
      subroutine td_strs_mat_18(state,dstate,ee,dmat,prop,rtimdat,
...
c
c
      subroutine prestr_mat_18(dmat,prop,autofac,iddmat,nprop,ierr,
     & errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c
      ...
      call elas_mat_18(dmat,ptmp,iddmat,nprop,ierr,errstrng)
      return
      end
c       

c version
c $Id: mat_18.f,v 1.4 2005/01/18 19:50:06 willic3 Exp $
