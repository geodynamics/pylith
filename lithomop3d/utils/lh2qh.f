...
c     hex mesh and convert it to a quadratic (20-node) hex mesh, by
c     inserting new nodes between the old ones.
c
      implicit none
      integer maxnodes,maxelmts,nsd,nenl,nenq,ietypeq
      parameter(maxnodes=500000,maxelmts=500000,nsd=3,nenl=8,nenq=20,
     & ietypeq=6)
...
c
      ...
      logical new
      data ind/1,2,2,3,3,4,4,1,5,6,6,7,7,8,8,5,1,5,2,6,3,7,4,8/
c
c...  open i/o files
c
      kni=10
