...
#
#
# This is a simple code to write out mesh information in a format resembling the
# original TECTON Ascii format.  In the future, more sophisticated output
# methods should be provided.
#

class MeshWriteAscii(MeshWrite):

    def initialize(self):

	print ""
        print "Hello from MeshWriteAscii.initialize (begin)!"
        print "Outputting Ascii mesh information:"

        # Parameters needed from Lithomop3d_setup.py.
...
# version
# $Id: MeshWriteAscii.py,v 1.1 2005/06/30 15:24:11 willic3 Exp $
