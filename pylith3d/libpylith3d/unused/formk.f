...
c
      subroutine formk(
     & alnz,ja,                                                         ! sparse
     & id,idx,x,d,dx,tfault,skew,iwink,wink,iwinkx,winkx,histry,        ! global
     ...
     & ngauss,nddmat,ndmat,nprop,numat,nsd,ndof,nstr,nen,nee,nnz,neq,   ! dimens
     & numel,numnp,numfn,numslp,numsn,numrot,nskdim,ipstrs,             ! dimens
     & nwink,nwinkx,nhist,lastep,idout,kto,kw)                          ! dimens
c
...
c
c version
c $Id: formk.f,v 1.1 2004/07/02 18:42:02 willic3 Exp $
c
