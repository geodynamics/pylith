...
c
      ierr=101
      errstrng="td_strs_mat_11"
c
      return
      end
c
c
      subroutine prestr_mat_11(dmat,prop,tpois,tyoungs,iddmat,ipauto,
     & nprop,ierr,errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c
      ...
      call elas_mat_11(dmat,ptmp,iddmat,nprop,ierr,errstrng)
      return
      end
c
c
      subroutine get_state_11(state,dstate,sout,nstate)
c
...
c
c
      subroutine update_state_11(state,dstate,nstate)
c
...
c       
c version
c $Id: mat_11.f,v 1.5 2005/04/01 23:10:16 willic3 Exp $
