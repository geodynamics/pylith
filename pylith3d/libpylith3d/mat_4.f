...
c
      ierr=101
      errstrng="td_strs_mat_4"
c
      return
      end
c
c
      subroutine prestr_mat_4(dmat,prop,tpois,tyoungs,iddmat,ipauto,
     & nprop,ierr,errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c
c
      subroutine get_state_4(state,dstate,sout,nstate)
c
...
c
c
      subroutine update_state_4(state,dstate,nstate)
c
...
c       
c version
c $Id: mat_4.f,v 1.5 2005/04/01 23:10:16 willic3 Exp $
