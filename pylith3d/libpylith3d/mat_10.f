...
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c
c...  Program segment to define material model 10:
c
c       Model number:                      10
c       Model name:                        ??
...
c                                          ??
c
      subroutine mat_prt_10(prop,nprop,matnum,idout,idsk,kw,kp,
     & ierr,errstrng)
c
c...  subroutine to output material properties for material model 10.
c
c     Error codes:
c         4:  Write error
...
c
c
      subroutine elas_mat_10(dmat,prop,iddmat,nprop,ierr,errstrng)
c
...
c
      ierr=101
      errstrng="td_strs_mat_10"
c
      return
      end
c
c
      subroutine prestr_mat_10(dmat,prop,tpois,tyoungs,iddmat,ipauto,
     & nprop,ierr,errstrng)
c
c...  subroutine to form the material matrix for an integration point
...
c
      ...
      call elas_mat_10(dmat,ptmp,iddmat,nprop,ierr,errstrng)
      return
      end
c
c
      subroutine get_state_10(state,dstate,sout,nstate)
c
...
c
c
      subroutine update_state_10(state,dstate,nstate)
c
...
c       
c version
c $Id: mat_10.f,v 1.5 2005/04/01 23:10:16 willic3 Exp $
