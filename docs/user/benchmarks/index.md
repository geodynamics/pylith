...
We have started developing a suite of performance benchmarks to document current PyLith performance and improvements with adjustments to solver settings.
The current benchmarks focus on solver performance for linear elasticity with prescribed fault slip.
...
The Crustal Deformation Modeling and Earthquake Source Physics Focus Groups within the Southern California Earthquake Center and the Short-Term Tectonics Working Group within CIG developed a suite of benchmarks to test the accuracy and performance of 3D numerical codes for quasistatic crustal deformation and earthquake rupture dynamics.
The benchmark definitions for the quasistatic crustal deformation benchmarks are posted on the CIG website at Short-Term Tectonics Benchmarks <https://geodynamics.org/groups/shortterm/wiki/MainPage/Benchmarks> and the definitions for the earthquake rupture benchmarks are posted on the SCEC website <https://strike.scec.org/cvws/cgi-bin/cvws.cgi>.
...
maxdepth: 1
---
legacy/quasistatic-strikeslip.md
legacy/savage-prescott.md
legacy/scec-dynrup.md
:::
