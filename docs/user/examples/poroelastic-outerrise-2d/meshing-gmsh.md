...
{numref}`fig:example:poroelastic:outerrise:2d:geometry:gmsh` shows the geometry and variables names of the vertices and curves.

:::{figure-md} fig:example:poroelastic:outerrise:2d:geometry:gmsh
