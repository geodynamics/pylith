...
:::{important}
The input mesh files for this example are not included in the source distribution.
Instructions for downloading the mesh files are available in `input/README.md`.
:::
