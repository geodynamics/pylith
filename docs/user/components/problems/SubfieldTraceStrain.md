...
* `alias`=\<str\>: Name for subfield.
  - **default value**: ''
  - **current value**: 'trace_strain', from {file='/software/unix/py39-venv/pylith-debug/lib/python3.9/site-packages/pythia/pyre/inventory/ConfigurableClass.py', line=26, function='__set__'}
