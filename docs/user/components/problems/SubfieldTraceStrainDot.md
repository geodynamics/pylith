...
:Full name: `pylith.problems.SubfieldTraceStrainDot`
:Journal name: `subfieldtracestrain_t`
...
Example of setting `SubfieldTraceStrainDot` Pyre properties and facilities in a parameter file.
