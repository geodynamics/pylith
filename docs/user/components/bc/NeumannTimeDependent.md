...
* `auxiliary_subfields`: Discretization information for auxiliary subfields.
  - **current value**: 'auxiliary_subfields', from {file='/Users/baagaard/software/unix/micromamba/envs/pylith-debug/lib/python3.12/site-packages/pythia/pyre/inventory/ConfigurableClass.py', line=26, function='__set__'}
...
* `label`=\<str\>: Name of label identifying boundary.
  ...
  - **validator**: <function validateLabel at 0x108fedc60>
...
* `ref_dir_1`=\<list\>: First choice for reference direction to discriminate among tangential directions in 3D.
  ...
  - **validator**: <function validateDir at 0x108fedf80>
