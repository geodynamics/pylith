...
namespace pylith {
    namespace mmstests {
        class TestIsotropicLinearPoroelasticity3D_QS_TT;

        class TestIsotropicLinearPoroelasticity3D_QS_TT_TetP2;
        class TestIsotropicLinearPoroelasticity3D_QS_TT_TetP3;
        class TestIsotropicLinearPoroelasticity3D_QS_TT_TetP4;

        class TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ2;
        class TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ3;
        class TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ4;

    } // materials
} // pylith

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT : public pylith::mmstests::TestIsotropicLinearPoroelasticity {
    ...
    static double biot_modulus(const double x,
                               const double y,
                               const double z) {
        return 1.0 / (porosity(x, y, z) / fluid_bulk_modulus(x, y, z) +
                      (biot_coefficient(x, y, z) - porosity(x, y, z)) / solid_bulk_modulus(x, y, z));
    }
    ...
    static double displacement_z(const double x,
                                 const double y,
                                 const double z,
                                 const double t) {
        return z * z - 2.0 * y * z;
    ...
    static double displacement_x_t(const double x,
                                   const double y,
                                   const double z,
                                   const double t) {
        return 0.0;
    ...
    static double displacement_y_t(const double x,
                                   const double y,
                                   const double z,
                                   const double t) {
        return 0.0;
    ...
    static double displacement_z_t(const double x,
                                   const double y,
                                   const double z,
                                   const double t) {
        return 0.0;
    ...
    static PetscErrorCode solnkernel_displacement(PetscInt spaceDim,
        ...
        s[0] = displacement_x(x[0], x[1], x[2], t);
        s[1] = displacement_y(x[0], x[1], x[2], t);
        s[2] = displacement_z(x[0], x[1], x[2], t);
    ...
    static PetscErrorCode solnkernel_displacement_t(PetscInt spaceDim,
        ...
        s[0] = displacement_x_t(x[0], x[1], x[2], t);
        s[1] = displacement_y_t(x[0], x[1], x[2], t);
        s[2] = displacement_z_t(x[0], x[1], x[2], t);
    ...
    static PetscErrorCode solnkernel_trace_strain_t(PetscInt spaceDim,
        ...
        s[0] = trace_strain_t(x[0], x[1], x[2], t);
...
protected:
    ...
    void setUp(void) {
        ...
        GenericComponent::setName("TestIsotropicLinearPoroelasticity3D_QS_TT");
        ...
        // Displacement BC
        static const PylithInt constrainedDisplacementDOF[3] = {0, 1, 2};
        static const PylithInt numConstrainedDisplacement = 3;
    ...
    void _setExactSolution(void) {
        ...
        err = PetscWeakFormSetIndexResidual(wf, label, 24, 0, 0, 1, pylith::fekernels::IsotropicLinearPoroelasticity3D::f0_mms_qt_u, 1, NULL);CPPUNIT_ASSERT(!err);
        err = PetscWeakFormSetIndexResidual(wf, label, 24, 1, 0, 1, pylith::fekernels::IsotropicLinearPoroelasticity3D::f0_mms_qt_p, 1, NULL);CPPUNIT_ASSERT(!err);
    } // _setExactSolution

}; // TestIsotropicLinearPoroelasticity3D_QS_TT
const double pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT::LENGTHSCALE = 1.0;
const double pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT::TIMESCALE = 1.0;
const double pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT::PRESSURESCALE = 1.0;
const double pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT::BODYFORCE = 1.0;
const double pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT::XMIN = -4.0;
const double pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT::XMAX = 4.0;

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_TetP2 : public pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearPoroelasticity3D_QS_TT_TetP2, TestIsotropicLinearPoroelasticity);
    CPPUNIT_TEST_SUITE_END();

    void setUp(void) {
        TestIsotropicLinearPoroelasticity3D_QS_TT::setUp();
        CPPUNIT_ASSERT(_data);
...
}; // TestIsotropicLinearPoroelasticity3D_QS_TT_TetP2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_TetP2);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_TetP3 : public pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearPoroelasticity3D_QS_TT_TetP3,
...
}; // TestIsotropicLinearPoroelasticity3D_QS_TT_TetP3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_TetP3);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_TetP4 : public pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearPoroelasticity3D_QS_TT_TetP4, TestIsotropicLinearPoroelasticity);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearPoroelasticity3D_QS_TT_TetP4
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_TetP4);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ2 : public pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ2, TestIsotropicLinearPoroelasticity);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ2);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ3 : public pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ3, TestIsotropicLinearPoroelasticity);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ3);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ4 : public pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ4, TestIsotropicLinearPoroelasticity);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ4
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearPoroelasticity3D_QS_TT_HexQ4);
