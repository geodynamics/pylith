...
protected:
    ...
    void _setExactSolution(void)
    {
        ...
        CPPUNIT_ASSERT(!err);
        err = PetscWeakFormSetIndexResidual(wf, label, 24, 0, 0, 1, pylith::fekernels::IsotropicLinearPoroelasticity3D::f0_mms_qt_u, 1, NULL);
        CPPUNIT_ASSERT(!err);
        err = PetscWeakFormSetIndexResidual(wf, label, 24, 1, 0, 1, pylith::fekernels::IsotropicLinearPoroelasticity3D::f0_mms_qt_p, 1, NULL);
        CPPUNIT_ASSERT(!err);
    } // _setExactSolution
