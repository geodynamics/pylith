...
protected:
    ...
    void _setExactSolution(void) {
        ...
        CPPUNIT_ASSERT(!err);
        err = PetscWeakFormSetIndexResidual(wf, NULL, 0, 0, 0, pylith::fekernels::IsotropicLinearPoroelasticity3D::f0_mms_qt_u, 0, NULL);
        CPPUNIT_ASSERT(!err);
        err = PetscWeakFormSetIndexResidual(wf, NULL, 0, 1, 1, pylith::fekernels::IsotropicLinearPoroelasticity3D::f0_mms_qt_p, 1, NULL);
        CPPUNIT_ASSERT(!err);
