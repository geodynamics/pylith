...
#include "TestSelfGrav.hh" // Implementation of class methods
...
// ------------------------------------------------------------------------------------------------
// Constuctor.
pylith::TestSelfGrav::TestSelfGrav(TestSelfGrav_Data* data) :
    _data(data) {
    assert(_data);
...
// ------------------------------------------------------------------------------------------------
// Destructor.
pylith::TestSelfGrav::~TestSelfGrav(void) {
...
void
pylith::TestSelfGrav::_initialize(void) {
    PYLITH_METHOD_BEGIN;
    assert(_mesh);
    assert(_data);
...
void
pylith::TestSelfGrav::_setExactSolution(void) {
