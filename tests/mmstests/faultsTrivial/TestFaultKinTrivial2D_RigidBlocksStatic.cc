 ...
 * 
 * Expanded to multivariable fault case
 */
...
class pylith::mmstests::TestFaultKinTrivial2D_RigidBlocksStatic :
    ...
    static PetscErrorCode solnkernel_mumultiplier(PetscInt spaceDim,
                                                        PetscReal t,
                                                        const PetscReal x[],
                                                        PetscInt numComponents,
                                                        PetscScalar* s,
...
class pylith::mmstests::TestFaultKinTrivial2D_RigidBlocksStatic_TriP1 :
    ...
    void setUp(void) {
        ...
        static const pylith::topology::Field::Discretization _solnDiscretizations[3] = {
            ...
            pylith::topology::Field::Discretization(1, 1, 1, -1, true), // mu_multiplier_fault
        };
...
class pylith::mmstests::TestFaultKinTrivial2D_RigidBlocksStatic_TriP2 :
    ...
    void setUp(void) {
        ...
        static const pylith::topology::Field::Discretization _solnDiscretizations[3] = {
            ...
            pylith::topology::Field::Discretization(2, 2, 1, -1, true), // mu_multiplier_fault
        };
        _data->solnDiscretizations = const_cast<pylith::topology::Field::Discretization*>(_solnDiscretizations);
...
class pylith::mmstests::TestFaultKinTrivial2D_RigidBlocksStatic_TriP3 :
    ...
    void setUp(void) {
        ...
        static const pylith::topology::Field::Discretization _solnDiscretizations[3] = {
            ...
            pylith::topology::Field::Discretization(3, 3, 1, -1, true), // mu_multiplier_fault
        };
        _data->solnDiscretizations = const_cast<pylith::topology::Field::Discretization*>(_solnDiscretizations);
