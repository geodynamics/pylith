...
namespace pylith {
    namespace mmstests {
        class TestIsotropicLinearElasticityLgDeform2D_BodyForce;

        class TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP2;
        class TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP3;
        class TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP4;

        class TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ2;
        class TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ3;
        class TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ4;

    } // materials
} // pylith

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce :
...
protected:
    ...
    void setUp(void) {
        ...
        GenericComponent::setName("TestIsotropicLinearElasticityLgDeform2D_BodyForce");
...
}; // TestIsotropicLinearElasticityLgDeform2D_BodyForce
const double pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce::LENGTHSCALE = 1.0e+3;
const double pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce::TIMESCALE = 2.0;
const double pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce::PRESSURESCALE = 2.25e+10;
const double pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce::BODYFORCE = 5.0e+3;
const double pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce::XMAX = 4.0e+3;

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP2 :
    public pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP2,
                           TestIsotropicLinearElasticityLgDeform);
    CPPUNIT_TEST_SUITE_END();

    void setUp(void) {
        TestIsotropicLinearElasticityLgDeform2D_BodyForce::setUp();
        CPPUNIT_ASSERT(_data);
...
}; // TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP2);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP3 :
    public pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP3,
                           TestIsotropicLinearElasticityLgDeform);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_TriP3);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ2 :
    public pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ2,  TestIsotropicLinearElasticityLgDeform);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ2);

// ---------------------------------------------------------------------------------------------------------------------
class pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ3 :
    public pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce {
    CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ3,  TestIsotropicLinearElasticityLgDeform);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestIsotropicLinearElasticityLgDeform2D_BodyForce_QuadQ3);
