...
/** @file tests/mmstests/faults/TestFaultKin2D_TwoBlocksStatic.cc
 *
...
namespace pylith {
    namespace mmstests {
        class TestFaultKin2D_TwoBlocksStatic;

        class TestFaultKin2D_TwoBlocksStatic_TriP1;
        class TestFaultKin2D_TwoBlocksStatic_TriP2;
        class TestFaultKin2D_TwoBlocksStatic_TriP3;
        class TestFaultKin2D_TwoBlocksStatic_TriP4;

        class TestFaultKin2D_TwoBlocksStatic_QuadQ1;
        class TestFaultKin2D_TwoBlocksStatic_QuadQ2;
        class TestFaultKin2D_TwoBlocksStatic_QuadQ3;
        class TestFaultKin2D_TwoBlocksStatic_QuadQ4;
    } // tests/mmstests
} // pylith

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic :
...
protected:
    ...
    void setUp(void) {
        ...
        GenericComponent::setName("TestFaultKin2D_TwoBlocksStatic");
...
}; // TestFaultKin2D_TwoBlocksStatic

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP1 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_TriP1,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();

    void setUp(void) {
        TestFaultKin2D_TwoBlocksStatic::setUp();
        CPPUNIT_ASSERT(_data);
...
}; // TestFaultKin2D_TwoBlocksStatic_TriP1
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP1);

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP2 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_TriP2,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestFaultKin2D_TwoBlocksStatic_TriP2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP2);

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP3 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_TriP3,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestFaultKin2D_TwoBlocksStatic_TriP3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP3);

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP4 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_TriP4,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestFaultKin2D_TwoBlocksStatic_TriP4
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_TriP4);

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ1 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_QuadQ1,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestFaultKin2D_TwoBlocksStatic_QuadQ1
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ1);

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ2 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_QuadQ2,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestFaultKin2D_TwoBlocksStatic_QuadQ2
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ2);

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ3 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_QuadQ3,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestFaultKin2D_TwoBlocksStatic_QuadQ3
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ3);

// ------------------------------------------------------------------------------------------------
class pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ4 :
    public pylith::mmstests::TestFaultKin2D_TwoBlocksStatic {
    CPPUNIT_TEST_SUB_SUITE(TestFaultKin2D_TwoBlocksStatic_QuadQ4,
                           TestFaultKin);
    CPPUNIT_TEST_SUITE_END();
...
}; // TestFaultKin2D_TwoBlocksStatic_QuadQ4
CPPUNIT_TEST_SUITE_REGISTRATION(pylith::mmstests::TestFaultKin2D_TwoBlocksStatic_QuadQ4);
