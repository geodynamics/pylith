...
#include "ConstRateDynamic.hh" // ISA ConstRateDynamic
...
// ------------------------------------------------------------------------------------------------
namespace pylith {
    class _ConstRateDynamic;
} // pylith

class pylith::_ConstRateDynamic {
    // Dimensionless
...
pylith::ConstRateDynamic::TriP1(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
...
// ------------------------------------------------------------------------------------------------
pylith::TestFaultKin_Data*
pylith::ConstRateDynamic::TriP2(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
...
// ------------------------------------------------------------------------------------------------
pylith::TestFaultKin_Data*
pylith::ConstRateDynamic::TriP3(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
...
// ------------------------------------------------------------------------------------------------
pylith::TestFaultKin_Data*
pylith::ConstRateDynamic::TriP4(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
...
// ------------------------------------------------------------------------------------------------
pylith::TestFaultKin_Data*
pylith::ConstRateDynamic::QuadQ1(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
...
// ------------------------------------------------------------------------------------------------
pylith::TestFaultKin_Data*
pylith::ConstRateDynamic::QuadQ2(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
...
// ------------------------------------------------------------------------------------------------
pylith::TestFaultKin_Data*
pylith::ConstRateDynamic::QuadQ3(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
...
// ------------------------------------------------------------------------------------------------
pylith::TestFaultKin_Data*
pylith::ConstRateDynamic::QuadQ4(void) {
    TestFaultKin_Data* data = pylith::_ConstRateDynamic::createData();assert(data);
