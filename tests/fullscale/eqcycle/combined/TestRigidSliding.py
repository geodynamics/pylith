...
import meshes
from rigidSliding_soln import AnalyticalSoln
...
# ----------------------------------------------------------------------------------------------------------------------
class RigidSlidingQuad(TestCase, meshes.Quad):
    NAME = "rigidSliding_quad"

    def setUp(self):
        TestCase.setUp(self)
        TestCase.run_pylith(
            self, self.NAME, ["rigidSliding.cfg", "rigidSliding_quad.cfg"])
        return


# ----------------------------------------------------------------------------------------------------------------------
class RigidSlidingTri(TestCase, meshes.Tri):
    NAME = "rigidSliding_tri"

    def setUp(self):
        TestCase.setUp(self)
        TestCase.run_pylith(
            self, self.NAME, ["rigidSliding.cfg", "rigidSliding_tri.cfg"])
        return
