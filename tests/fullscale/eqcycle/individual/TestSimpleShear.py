...
import meshes
from simpleShear_soln import AnalyticalSoln
...
class TestQuad(TestCase, meshes.Quad):
    NAME = "simpleShear_quad"

    def setUp(self):
        TestCase.setUp(self)
        TestCase.run_pylith(
            self, self.NAME, ["simpleShear.cfg", "simpleShear_quad.cfg"])
        return


# ----------------------------------------------------------------------------------------------------------------------
class TestTri(TestCase, meshes.Tri):
    NAME = "simpleShear_tri"

    def setUp(self):
        TestCase.setUp(self)
        TestCase.run_pylith(
            self, self.NAME, ["simpleShear.cfg", "simpleShear_tri.cfg"])
        return
