...
class TestQuad(TestCase):
    ...
    def setUp(self):
        ...
        TestCase.run_pylith(self, self.name, ["opening.cfg", "opening_quad.cfg"])
...
class TestTri(TestCase):
    ...
    def setUp(self):
        ...
        TestCase.run_pylith(self, self.name, ["opening.cfg", "opening_tri.cfg"])
