...
class TestQuad(TestCase):
    ...
    def setUp(self):
        self.name = "simpleshear_quad"
        self.mesh = meshes.Quad()
        super().setUp()

        TestCase.run_pylith(self, self.name, ["simpleshear.cfg", "simpleshear_quad.cfg"])
        return
...
class TestTri(TestCase):
    ...
    def setUp(self):
        ...
        self.name = "simpleshear_tri"
        self.mesh = meshes.Tri()
        super().setUp()

        TestCase.run_pylith(self, self.name, ["simpleshear.cfg", "simpleshear_tri.cfg"])
        return
