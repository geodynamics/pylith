...
# ----------------------------------------------------------------------
#
# @file tests/fullscale/cornercases/3d/axialdisp_pgram_gendb.py
#
...
class GenerateDB(object):
    ...
    def run(self):
        ...
        """
        # Domain
        x = numpy.arange(-6.0e+3, 6.01e+3, 1.0e+3)
        y = numpy.arange(-6.0e+3, 6.01e+3, 1.0e+3)
        z = numpy.arange(-9.0e+3, 3.01e+3, 1.0e+3)
        ...
        io = SimpleGridAscii()
        io.inventory.filename = "axialdisp_pgram_bc.spatialdb"
        io._configure()
        io.write(data)
        return
