...
from pylith.initializers.MeshReader import (MeshReader, initialize_phase)


class TestMeshReader(TestComponent):
    """Unit testing of MeshReader object.
    """
    _class = MeshReader
