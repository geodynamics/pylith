...
#include "TestIsotropicLinearElasticityLgDeformPlaneStrain.hh" // Implementation of class methods

#include "pylith/materials/IsotropicLinearElasticityLgDeformPlaneStrain.hh" // USES IsotropicLinearElasticityLgDeformPlaneStrain
...
// Setup testing data.
void
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::setUp(void) {
    TestMaterial::setUp();
    _mymaterial = new IsotropicLinearElasticityLgDeformPlaneStrain();CPPUNIT_ASSERT(_mymaterial);
    _mydata = NULL;

    GenericComponent::setName("TestIsotropicLinearElasticityLgDeformPlaneStrain");

    _mymaterial->PyreComponent::identifier("TestIsotropicLinearElasticityLgDeformPlaneStrain");
...
void
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::tearDown(void) {
    const char* journal = _mymaterial->PyreComponent::getName();
...
void
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::testAccessors(void) {
    PYLITH_METHOD_BEGIN;
...
// Test auxFieldsSetup().
void
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::test_auxiliaryFieldSetup(void) {
    PYLITH_METHOD_BEGIN;
...
// Test getAuxField().
void
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::testGetAuxField(void) {
    PYLITH_METHOD_BEGIN;
...
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::_material(void) {
    return _mymaterial;
} // _material
...
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::_data(void) {
    return _mydata;
} // _data
...
void
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain::_setupSolutionFields(void) {
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
// Constructor
pylith::materials::TestIsotropicLinearElasticityLgDeformPlaneStrain_Data::TestIsotropicLinearElasticityLgDeformPlaneStrain_Data(void) {
    dimension = 2;
