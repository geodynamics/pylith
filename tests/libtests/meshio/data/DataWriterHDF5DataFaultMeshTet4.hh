...
#if !defined(pylith_meshio_datawriterhdf5datafaultmeshtet4_hh)
#define pylith_meshio_datawriterhdf5datafaultmeshtet4_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
    namespace meshio {
        class DataWriterHDF5DataFaultMeshTet4;
    } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataFaultMeshTet4 : public DataWriterData { // DataWriterHDF5DataFaultMeshTet4
public:

    /// Constructor
    DataWriterHDF5DataFaultMeshTet4(void);
...
#endif // pylith_meshio_datawriterhdf5datafaultmeshtet4_hh
