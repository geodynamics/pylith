...
#include "DataWriterHDF5DataFaultMeshTri3.hh"

#include <assert.h> // USES assert()

const char* pylith::meshio::DataWriterHDF5DataFaultMeshTri3::_meshFilename = 
  "data/tri3.mesh";

const char* pylith::meshio::DataWriterHDF5DataFaultMeshTri3::_faultLabel = 
  "fault";
const int pylith::meshio::DataWriterHDF5DataFaultMeshTri3::_faultId = 100;

const char* pylith::meshio::DataWriterHDF5DataFaultMeshTri3::_timestepFilename = 
  "tri3_fault.h5";
