...
#if !defined(pylith_meshio_datawriterhdf5datafaultmeshquad4_hh)
#define pylith_meshio_datawriterhdf5datafaultmeshquad4_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataFaultMeshQuad4;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataFaultMeshQuad4 : public DataWriterData
{ // DataWriterHDF5DataFaultMeshQuad4

public: 

  /// Constructor
  DataWriterHDF5DataFaultMeshQuad4(void);
...
#endif // pylith_meshio_datawriterhdf5datafaultmeshquad4_hh
