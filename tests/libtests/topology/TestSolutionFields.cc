...
// Test constructor.
void
pylith::topology::TestSolutionFields::testConstructor(void) { // testConstructor
    PYLITH_METHOD_BEGIN;
...
// Test solutionName().
void
pylith::topology::TestSolutionFields::testSolutionName(void) { // testSolutionName
    PYLITH_METHOD_BEGIN;
...
// Test solution().
void
pylith::topology::TestSolutionFields::testSolution(void) { // testSolution
    PYLITH_METHOD_BEGIN;
    ...
    fieldB.createDiscretization();
    fieldB.allocate();
    fieldC.newSection(fieldB, fiberDimC);
    fidldC.createDiscretization();
    fieldC.allocate();
...
// ----------------------------------------------------------------------
void
pylith::topology::TestSolutionFields::_initialize(Mesh* mesh) const { // _initialize
    PYLITH_METHOD_BEGIN;
