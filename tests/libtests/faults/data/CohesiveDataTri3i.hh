...
#if !defined(pylith_faults_cohesivedatatri3i_hh)
#define pylith_faults_cohesivedatatri3i_hh

#include "CohesiveData.hh"

namespace pylith {
  namespace faults {
     class CohesiveDataTri3i;
  } // pylith
} // faults

class pylith::faults::CohesiveDataTri3i : public CohesiveData
{
...
#endif // pylith_faults_cohesivedatatri3i_hh
