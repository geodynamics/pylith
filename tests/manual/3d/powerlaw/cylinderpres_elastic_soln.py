...
## @file tests/manual/3d/powerlaw/cylinderpres_elastic_soln.py

## @brief Analytical steady-state solution for pressurized elastic cylinder.
...
# C1 = (1.0 - 2.0*p_poisson)*(1.0 + p_poisson)*(Pb*b*b - Pa*a*a)/(p_young*(a*a -b*b))
# C2 = (1.0 + p_poisson)*(Pb - Pa)*a*a*b*b/(p_young*(a*a -b*b))
A = Pb*a*a*b*b/(b*b - a*a)
C = -0.5*Pb*b*b/(b*b - a*a)
# C = 0.5*p_young*C1/((1.0 + p_poisson)*(1.0 - 2.0*p_poisson))
