...
## @file tests/2d/slipdir/faultx_soln.py
##
## @brief Analytical solution to faultx (rigid motion).
...
class AnalyticalSoln(object):
  ...
  def displacement(self, locs):
    ...
    """
    raise NotImplementedError("AnalyticalSoln.displacement() not implemented")
    return
...
# ----------------------------------------------------------------------
class SolnFaultX(AnalyticalSoln):
  """
  Analytical solution to faultx problem.
  """
  ...
  def displacement(self, locs):
    ...
    maskP = locs[:,1] > 0.0
    maskN = ~maskP
    disp[0,:,0] = maskN*(+1.0) + maskP*(-1.0)
    return disp


# ----------------------------------------------------------------------
class SolnFaultY(AnalyticalSoln):
  """
  Analytical solution to faultx problem.
  """
...
# ----------------------------------------------------------------------
class SolnFaultXYP(AnalyticalSoln):
  """
  Analytical solution to faultxyp problem.
  """
  ...
  def displacement(self, locs):
    ...
    maskP = locs[:,1] > locs[:,0]
    maskN = ~maskP
    disp[0,:,0] = 0.5**0.5*(maskN*(+1.0) + maskP*(-1.0))
    disp[0,:,1] = 0.5**0.5*(maskN*(+1.0) + maskP*(-1.0))
    return disp


# ----------------------------------------------------------------------
class SolnFaultXYN(AnalyticalSoln):
  """
  Analytical solution to faultxyn problem.
  """
