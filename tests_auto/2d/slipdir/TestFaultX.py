...
## @file tests/2d/slipdir/TestFaultX.py
##
...
from solution import SolnFaultX as AnalyticalSoln
from genspatialdb import GenDBFaultX as GenerateDB

# Local version of PyLithApp
from pylith.apps.PyLithApp import PyLithApp
class FaultXApp(PyLithApp):
  def __init__(self):
...
if __name__ == '__main__':
  import unittest
  from TestFaultX import TestFaultX as Tester
