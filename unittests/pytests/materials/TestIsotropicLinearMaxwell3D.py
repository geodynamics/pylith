...
# @file unittests/pytests/materials/TestIsotropicLinearMaxwell3D.py

# @brief Unit testing of TestIsotropicLinearMaxwell3D object.

import unittest

from pylith.materials.IsotropicLinearMaxwell3D import IsotropicLinearMaxwell3D
from pylith.tests.UnitTestApp import configureSubcomponents


class TestIsotropicLinearMaxwell3D(unittest.TestCase):
    """
    Unit testing of TestIsotropicLinearMaxwell3D object.
    """
    ...
    def setUp(self):
        ...
        Setup test subject.
        """
        self.material = IsotropicLinearMaxwell3D()
    ...
    def test_preinitialize(self):
        ...
        from pylith.materials.IsotropicLinearMaxwell3D import ModuleMaterial
    ...
    def test_factory(self):
        ...
        Test factory method.
        """
        from pylith.materials.IsotropicLinearMaxwell3D import material
        self.assertTrue(isinstance(material(), IsotropicLinearMaxwell3D))
        return
