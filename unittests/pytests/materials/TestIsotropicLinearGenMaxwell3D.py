...
# @file unittests/pytests/materials/TestIsotropicLinearGenMaxwell3D.py

# @brief Unit testing of TestIsotropicLinearGenMaxwell3D object.

import unittest

from pylith.materials.IsotropicLinearGenMaxwell3D import IsotropicLinearGenMaxwell3D
from pylith.tests.UnitTestApp import configureSubcomponents


class TestIsotropicLinearGenMaxwell3D(unittest.TestCase):
    """
    Unit testing of TestIsotropicLinearGenMaxwell3D object.
    """
    ...
    def setUp(self):
        ...
        Setup test subject.
        """
        self.material = IsotropicLinearGenMaxwell3D()
    ...
    def test_preinitialize(self):
        ...
        from pylith.materials.IsotropicLinearGenMaxwell3D import ModuleMaterial
    ...
    def test_factory(self):
        ...
        Test factory method.
        """
        from pylith.materials.IsotropicLinearGenMaxwell3D import material
        self.assertTrue(isinstance(material(), IsotropicLinearGenMaxwell3D))
        return
