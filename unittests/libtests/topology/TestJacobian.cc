...
// Test constructor.
void
pylith::topology::TestJacobian::testConstructor(void) { // testConstructor
    PYLITH_METHOD_BEGIN;
...
void
pylith::topology::TestJacobian::testConstructorSubDomain(void) { // testConstructorSubDomain
    PYLITH_METHOD_BEGIN;
...
// Test matrix().
void
pylith::topology::TestJacobian::testMatrix(void) { // testMatrix
    PYLITH_METHOD_BEGIN;
...
// Test assemble().
void
pylith::topology::TestJacobian::testAssemble(void) { // testAssemble
    PYLITH_METHOD_BEGIN;
...
// Test zero().
void
pylith::topology::TestJacobian::testZero(void) { // testZero
    PYLITH_METHOD_BEGIN;
...
// Test view().
void
pylith::topology::TestJacobian::testView(void) { // testView
    PYLITH_METHOD_BEGIN;
...
// Test write().
void
pylith::topology::TestJacobian::testWrite(void) { // testWrite
    PYLITH_METHOD_BEGIN;
...
// ----------------------------------------------------------------------
void
pylith::topology::TestJacobian::_initializeMesh(Mesh* mesh) const { // _initializeMesh
    PYLITH_METHOD_BEGIN;
...
pylith::topology::TestJacobian::_initializeField(Mesh* mesh,
                                                 Field* field) const { // _initializeField
    PYLITH_METHOD_BEGIN;
