...
namespace pylith {
  namespace feassemble {
     class ElasticityImplicitGravData2DLinear;
  } // pylith
} // feassemble

class pylith::feassemble::ElasticityImplicitGravData2DLinear : public IntegratorData
{

public: 

  /// Constructor
  ElasticityImplicitGravData2DLinear(void);
...
#endif // pylith_feassemble_elasticityimplicitgravdata2dlinear_hh
