...
namespace pylith {
  namespace feassemble {
     class ElasticityImplicitGravData1DQuadratic;
  } // pylith
} // feassemble

class pylith::feassemble::ElasticityImplicitGravData1DQuadratic : public IntegratorData
{

public: 

  /// Constructor
  ElasticityImplicitGravData1DQuadratic(void);
...
#endif // pylith_feassemble_elasticityimplicitgravdata1dquadratic_hh
