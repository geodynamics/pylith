...
const int pylith::feassemble::ElasticityImplicitGravData2DQuadratic::_spaceDim = 2;

const int pylith::feassemble::ElasticityImplicitGravData2DQuadratic::_cellDim = 2;

const int pylith::feassemble::ElasticityImplicitGravData2DQuadratic::_numVertices = 6;

const int pylith::feassemble::ElasticityImplicitGravData2DQuadratic::_numCells = 1;
...
const char* pylith::feassemble::ElasticityImplicitGravData2DQuadratic::_matDBFilename = "data/elasticplanestrain.spatialdb";

const int pylith::feassemble::ElasticityImplicitGravData2DQuadratic::_matId = 0;
...
const int pylith::feassemble::ElasticityImplicitGravData2DQuadratic::_cells[] = {
0,1,2,3,4,5,
};
