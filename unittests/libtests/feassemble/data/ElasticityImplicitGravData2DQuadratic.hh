...
namespace pylith {
  namespace feassemble {
     class ElasticityImplicitGravData2DQuadratic;
  } // pylith
} // feassemble

class pylith::feassemble::ElasticityImplicitGravData2DQuadratic : public IntegratorData
{

public: 

  /// Constructor
  ElasticityImplicitGravData2DQuadratic(void);
...
#endif // pylith_feassemble_elasticityimplicitgravdata2dquadratic_hh
