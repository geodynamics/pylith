...
namespace pylith {
  namespace feassemble {
     class ElasticityImplicitGravData3DQuadratic;
  } // pylith
} // feassemble

class pylith::feassemble::ElasticityImplicitGravData3DQuadratic : public IntegratorData
{

public: 

  /// Constructor
  ElasticityImplicitGravData3DQuadratic(void);
...
#endif // pylith_feassemble_elasticityimplicitgravdata3dquadratic_hh
