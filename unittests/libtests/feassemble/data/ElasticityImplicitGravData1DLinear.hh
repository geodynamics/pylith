...
namespace pylith {
  namespace feassemble {
     class ElasticityImplicitGravData1DLinear;
  } // pylith
} // feassemble

class pylith::feassemble::ElasticityImplicitGravData1DLinear : public IntegratorData
{

public: 

  /// Constructor
  ElasticityImplicitGravData1DLinear(void);
...
#endif // pylith_feassemble_elasticityimplicitgravdata1dlinear_hh
