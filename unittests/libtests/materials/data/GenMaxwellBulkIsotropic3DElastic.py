...
## @file unittests/libtests/materials/data/GenMaxwellBulkIsotropic3DElastic.py

## @brief Python application for generating C++ data files for testing
## C++ GenMaxwellBulkIsotropic3D object with elastic behavior.
...
# GenMaxwellBulkIsotropic3DElastic class
class GenMaxwellBulkIsotropic3DElastic(ElasticMaterialApp):
  """
  Python application for generating C++ data files for testing C++
  GenMaxwellBulkIsotropic3D object with elastic behavior.
  """
...
if __name__ == "__main__":
  ...
  app = GenMaxwellBulkIsotropic3DElastic()
  app.run()
