...
#if !defined(pylith_materials_genmaxwellbulkisotropic3delasticdata_hh)
#define pylith_materials_genmaxwellbulkisotropic3delasticdata_hh
...
class pylith::materials::GenMaxwellBulkIsotropic3DElasticData : public ElasticMaterialData
{

public: 

  /// Constructor
  GenMaxwellBulkIsotropic3DElasticData(void);
...
#endif // pylith_materials_genmaxwellbulkisotropic3delasticdata_hh
