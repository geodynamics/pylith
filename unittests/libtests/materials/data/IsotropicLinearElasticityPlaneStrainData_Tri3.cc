...
// This file was generated from python application IsotropicLinearElasticityPlaneStrain.pyc.
...
const PetscPointFunc pylith::materials::IsotropicLinearElasticityPlaneStrainData_Tri3::_residualKernels[2] = {
  NULL,
  pylith_fekernels_f1_IsotropicLinearElasticityPlaneStrain,
};

const PetscPointJac pylith::materials::IsotropicLinearElasticityPlaneStrainData_Tri3::_jacobianKernels[4] = {
  NULL,
  NULL,
  NULL,
