...
#if !defined(pylith_materials_genmaxwellbulkisotropic3dtimedepdata_hh)
#define pylith_materials_genmaxwellbulkisotropic3dtimedepdata_hh
...
class pylith::materials::GenMaxwellBulkIsotropic3DTimeDepData : public ElasticMaterialData
{

public: 

  /// Constructor
  GenMaxwellBulkIsotropic3DTimeDepData(void);
...
#endif // pylith_materials_genmaxwellbulkisotropic3dtimedepdata_hh
