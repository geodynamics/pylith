...
class pylith::materials::TestIsotropicLinearGenMaxwell3D_LinearStrain :
	...
	static double viscousStrain_1_xx(const double x,
		...
		return 2.0*maxwellTime_1(x,y,z)*(exp(constants.t/maxwellTime_1(x,y,z)) - 1)*
			...
			exp(-constants.t*(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z) + maxwellTime_1(x,y,z)*maxwellTime_3(x,y,z) + 2.0*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z)))/(3.0*constants.t);
	} // viscousStrain_1_xx
	...
	static double viscousStrain_1_xy(const double x,
		...
		return maxwellTime_1(x,y,z)*(exp(constants.t/maxwellTime_1(x,y,z)) - 1.0)*
			(shearModulusRatio_1(x,y,z)*exp(constants.t*(maxwellTime_2(x,y,z) + maxwellTime_3(x,y,z))/(maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))) +
			 ...
			 shearModulusRatio_3(x,y,z)*exp(constants.t*(maxwellTime_1(x,y,z) + maxwellTime_2(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z))))*
			(constants.b*(x + y) + constants.c*(x + y) + z*(constants.d + constants.e))*
			exp(-constants.t*(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z) + maxwellTime_1(x,y,z)*maxwellTime_3(x,y,z) + 2.0*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z)))/constants.t;
	} // viscousStrain_1_xy
	...
	static double viscousStrain_2_xx(const double x,
		...
		return 2.0*maxwellTime_2(x,y,z)*(exp(constants.t/maxwellTime_2(x,y,z)) - 1.0)*
			(shearModulusRatio_1(x,y,z)*exp(constants.t*(maxwellTime_2(x,y,z) + maxwellTime_3(x,y,z))/(maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))) +
			 ...
			 shearModulusRatio_3(x,y,z)*exp(constants.t*(maxwellTime_1(x,y,z) + maxwellTime_2(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z))))*
			(constants.a*(2.0*x - y - z) + constants.b*(2.0*y - x) + constants.d*(2.0*z - x) -constants.e*(y + z))*
			exp(-constants.t*(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z) + 2.0*maxwellTime_1(x,y,z)*maxwellTime_3(x,y,z) + maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z)))/(3.0*constants.t);
	} // viscousStrain_2_xx
	...
	static double viscousStrain_2_xy(const double x,
		...
		return maxwellTime_2(x,y,z)*(exp(constants.t/maxwellTime_2(x,y,z)) - 1.0) *
			(shearModulusRatio_1(x,y,z)*exp(constants.t*(maxwellTime_2(x,y,z) + maxwellTime_3(x,y,z))/(maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))) +
			 ...
			 shearModulusRatio_3(x,y,z)*exp(constants.t*(maxwellTime_1(x,y,z) + maxwellTime_2(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)))) *
			(constants.b*(x + y) + constants.c*(x + y) + z*(constants.d + constants.e))*
			exp(-constants.t*(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z) + 2.0*maxwellTime_1(x,y,z)*maxwellTime_3(x,y,z) + maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z)))/constants.t;
	} // viscousStrain_2_xy
	...
	static double viscousStrain_3_xx(const double x,
		...
		return 2.0*maxwellTime_3(x,y,z)*(exp(constants.t/maxwellTime_3(x,y,z)) - 1.0) *
			(shearModulusRatio_1(x,y,z)*exp(constants.t*(maxwellTime_2(x,y,z) + maxwellTime_3(x,y,z))/(maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))) +
			 ...
			 shearModulusRatio_3(x,y,z)*exp(constants.t*(maxwellTime_1(x,y,z) + maxwellTime_2(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)))) *
			(constants.a*(2.0*x - y - z) + constants.b*(2.0*y - x) + constants.d*(2.0*z - x) -constants.e*(y + z))*
			exp(-constants.t*(2.0*maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z) + maxwellTime_1(x,y,z)*maxwellTime_3(x,y,z) + maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z)))/(3.0*constants.t);
	} // viscousStrain_3_xx
	...
	static double viscousStrain_3_xy(const double x,
		...
		return maxwellTime_3(x,y,z)*(exp(constants.t/maxwellTime_3(x,y,z)) - 1.0) *
			(shearModulusRatio_1(x,y,z)*exp(constants.t*(maxwellTime_2(x,y,z) + maxwellTime_3(x,y,z))/(maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))) +
			 ...
			 shearModulusRatio_3(x,y,z)*exp(constants.t*(maxwellTime_1(x,y,z) + maxwellTime_2(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)))) *
			(constants.b*(x + y) + constants.c*(x + y) + z*(constants.d + constants.e))*
			exp(-constants.t*(2.0*maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z) + maxwellTime_1(x,y,z)*maxwellTime_3(x,y,z) + maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z))/(maxwellTime_1(x,y,z)*maxwellTime_2(x,y,z)*maxwellTime_3(x,y,z)))/constants.t;
	} // viscousStrain_3_xy
...
protected:
	void setUp(void) {
		...
		static const pylith::topology::Field::Discretization _auxDiscretizations[8] = {
			...
			{0, 1, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // shear_modulus_ratio
		...
		_mymaterial->label("Isotropic Linear Generalized Maxwell 3D");
		_mymaterial->id(24);
...
class pylith::materials::TestIsotropicLinearGenMaxwell3D_LinearStrain_TetP2 :
	...
	void setUp(void) {
		...
		static const pylith::topology::Field::Discretization _auxDiscretizations[8] = {
			...
			{0, 2, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // shear_modulus_ratio
...
class pylith::materials::TestIsotropicLinearGenMaxwell3D_LinearStrain_TetP3 :
	...
	void setUp(void) {
		...
		static const pylith::topology::Field::Discretization _auxDiscretizations[8] = {
			...
			{0, 3, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // shear_modulus_ratio
...
class pylith::materials::TestIsotropicLinearGenMaxwell3D_LinearStrain_TetP4 :
	...
	void setUp(void) {
		...
		static const pylith::topology::Field::Discretization _auxDiscretizations[8] = {
			...
			{0, 4, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // shear_modulus_ratio
