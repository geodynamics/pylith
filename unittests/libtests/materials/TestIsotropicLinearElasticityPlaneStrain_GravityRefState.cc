...
namespace pylith {
    namespace materials {
        ...
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState : public TestIsotropicLinearElasticityPlaneStrain {
...
protected:
            ...
            void setUp(void) {
                ...
                static const pylith::topology::Field::Discretization _auxDiscretizations[6] = {
                    ...
                    {0, 1, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // reference_stress
        ...
        const double TestIsotropicLinearElasticityPlaneStrain_GravityRefState::SMALL = 0.1;
        const double TestIsotropicLinearElasticityPlaneStrain_GravityRefState::GACC = 9.80665;
        const double TestIsotropicLinearElasticityPlaneStrain_GravityRefState::YMAX = +4.0e+3;

        // ----------------------------------------------------------------------

        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP1 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState {

            CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP1,  TestIsotropicLinearElasticityPlaneStrain);
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP1);


        // ----------------------------------------------------------------------
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP2 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState {

            CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP2,  TestIsotropicLinearElasticityPlaneStrain);
            CPPUNIT_TEST_SUITE_END();
            ...
            void setUp(void) {
                ...
                static const pylith::topology::Field::Discretization _auxDiscretizations[6] = {
                    ...
                    {0, 2, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // reference_stress
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP2);


        // ----------------------------------------------------------------------
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP3 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState {

            CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP3,  TestIsotropicLinearElasticityPlaneStrain);
            CPPUNIT_TEST_SUITE_END();
            ...
            void setUp(void) {
                ...
                static const pylith::topology::Field::Discretization _auxDiscretizations[6] = {
                    ...
                    {0, 3, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // reference_stress
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP3);


        // ----------------------------------------------------------------------
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP4 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState {

            CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP4,  TestIsotropicLinearElasticityPlaneStrain);
            CPPUNIT_TEST_SUITE_END();
            ...
            void setUp(void) {
                ...
                static const pylith::topology::Field::Discretization _auxDiscretizations[6] = {
                    ...
                    {0, 4, true, pylith::topology::Field::POLYNOMIAL_SPACE}, // reference_stress
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_TriP4);


        // ----------------------------------------------------------------------
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ1 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState { // TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ1

            CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ1,  TestIsotropicLinearElasticityPlaneStrain);
            CPPUNIT_TEST_SUITE_END();
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ1);


        // ----------------------------------------------------------------------
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ2 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState { // TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ2
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ2);


        // ----------------------------------------------------------------------
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ3 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState { // TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ3

            CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ3,  TestIsotropicLinearElasticityPlaneStrain);
            CPPUNIT_TEST_SUITE_END();
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ3);


        // ----------------------------------------------------------------------
        class TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ4 : public TestIsotropicLinearElasticityPlaneStrain_GravityRefState { // TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ4

            CPPUNIT_TEST_SUB_SUITE(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ4,  TestIsotropicLinearElasticityPlaneStrain);
            CPPUNIT_TEST_SUITE_END();
        ...
        CPPUNIT_TEST_SUITE_REGISTRATION(TestIsotropicLinearElasticityPlaneStrain_GravityRefState_QuadQ4);
