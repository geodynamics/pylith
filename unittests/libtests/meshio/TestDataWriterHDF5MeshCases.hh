...
namespace pylith {
  namespace meshio {
    class TestDataWriterHDF5MeshLine2;
...
// ----------------------------------------------------------------------
/// C++ unit testing for DataWriterHDF5
class pylith::meshio::TestDataWriterHDF5MeshLine2 : public TestDataWriterHDF5Mesh
{ // class TestDataWriterHDF5MeshLine2

  // CPPUNIT TEST SUITE /////////////////////////////////////////////////
  CPPUNIT_TEST_SUITE( TestDataWriterHDF5MeshLine2 );
