...
#if !defined(pylith_meshio_datawriterhdf5datasubmeshline2_hh)
#define pylith_meshio_datawriterhdf5datasubmeshline2_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataSubMeshLine2;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataSubMeshLine2 : public DataWriterData
{ // DataWriterHDF5DataSubMeshLine2

public: 

  /// Constructor
  DataWriterHDF5DataSubMeshLine2(void);
...
#endif // pylith_meshio_datawriterhdf5datasubmeshline2_hh
