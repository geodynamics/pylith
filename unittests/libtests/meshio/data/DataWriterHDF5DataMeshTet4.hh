...
#if !defined(pylith_meshio_datawriterhdf5datameshtet4_hh)
#define pylith_meshio_datawriterhdf5datameshtet4_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataMeshTet4;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataMeshTet4 : public DataWriterData
{ // DataWriterHDF5DataMeshTet4

public: 

  /// Constructor
  DataWriterHDF5DataMeshTet4(void);
...
#endif // pylith_meshio_datawriterhdf5datameshtet4_hh
