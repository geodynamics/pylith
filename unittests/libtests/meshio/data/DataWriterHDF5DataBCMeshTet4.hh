...
#if !defined(pylith_meshio_datawriterhdf5databcmeshtet4_hh)
#define pylith_meshio_datawriterhdf5databcmeshtet4_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataBCMeshTet4;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataBCMeshTet4 : public DataWriterData
{ // DataWriterHDF5DataBCMeshTet4

public: 

  /// Constructor
  DataWriterHDF5DataBCMeshTet4(void);
...
#endif // pylith_meshio_datawriterhdf5databcmeshtet4_hh
