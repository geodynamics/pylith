...
#if !defined(pylith_meshio_datawriterhdf5datamatmeshtet4_hh)
#define pylith_meshio_datawriterhdf5datamatmeshtet4_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataMatMeshTet4;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataMatMeshTet4 : public DataWriterData
{ // DataWriterHDF5DataMatMeshTet4

public: 

  /// Constructor
  DataWriterHDF5DataMatMeshTet4(void);
...
#endif // pylith_meshio_datawriterhdf5datamatmeshtet4_hh
