...
#if !defined(pylith_meshio_datawriterhdf5datameshquad4_hh)
#define pylith_meshio_datawriterhdf5datameshquad4_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataMeshQuad4;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataMeshQuad4 : public DataWriterData
{ // DataWriterHDF5DataMeshQuad4

public: 

  /// Constructor
  DataWriterHDF5DataMeshQuad4(void);
...
#endif // pylith_meshio_datawriterhdf5datameshquad4_hh
