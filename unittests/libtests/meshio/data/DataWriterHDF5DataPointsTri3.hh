...
#if !defined(pylith_meshio_datawriterhdf5datapointstri3_hh)
#define pylith_meshio_datawriterhdf5datapointstri3_hh

#include "DataWriterDataPoints.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataPointsTri3;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataPointsTri3 : public DataWriterDataPoints
{ // DataWriterHDF5DataPointsTri3

public: 

  /// Constructor
  DataWriterHDF5DataPointsTri3(void);
...
#endif // pylith_meshio_datawriterhdf5datapointstri3_hh
