...
#if !defined(pylith_meshio_datawriterhdf5datamatmeshtri3_hh)
#define pylith_meshio_datawriterhdf5datamatmeshtri3_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataMatMeshTri3;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataMatMeshTri3 : public DataWriterData
{ // DataWriterHDF5DataMatMeshTri3

public: 

  /// Constructor
  DataWriterHDF5DataMatMeshTri3(void);
...
#endif // pylith_meshio_datawriterhdf5datamatmeshtri3_hh
