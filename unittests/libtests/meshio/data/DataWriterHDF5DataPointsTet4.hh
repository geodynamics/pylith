...
#if !defined(pylith_meshio_datawriterhdf5datapointstet4_hh)
#define pylith_meshio_datawriterhdf5datapointstet4_hh

#include "DataWriterDataPoints.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataPointsTet4;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataPointsTet4 : public DataWriterDataPoints
{ // DataWriterHDF5DataPointsTet4

public: 

  /// Constructor
  DataWriterHDF5DataPointsTet4(void);
...
#endif // pylith_meshio_datawriterhdf5datapointstet4_hh
