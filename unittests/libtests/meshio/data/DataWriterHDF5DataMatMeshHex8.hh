...
#if !defined(pylith_meshio_datawriterhdf5datamatmeshhex8_hh)
#define pylith_meshio_datawriterhdf5datamatmeshhex8_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataMatMeshHex8;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataMatMeshHex8 : public DataWriterData
{ // DataWriterHDF5DataMatMeshHex8

public: 

  /// Constructor
  DataWriterHDF5DataMatMeshHex8(void);
...
#endif // pylith_meshio_datawriterhdf5datamatmeshhex8_hh
