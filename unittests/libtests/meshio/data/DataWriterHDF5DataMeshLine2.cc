...
#include "DataWriterHDF5DataMeshLine2.hh"

#include <assert.h> // USES assert()

const char* pylith::meshio::DataWriterHDF5DataMeshLine2::_meshFilename = 
  "data/line2.mesh";

const char* pylith::meshio::DataWriterHDF5DataMeshLine2::_faultLabel = 
  "fault";
const int pylith::meshio::DataWriterHDF5DataMeshLine2::_faultId = 100;

const char* pylith::meshio::DataWriterHDF5DataMeshLine2::_timestepFilename = 
  "line2.h5";

const char* pylith::meshio::DataWriterHDF5DataMeshLine2::_vertexFilename = 
  "line2_vertex.h5";
