...
#if !defined(pylith_meshio_datawriterhdf5databcmeshtri3_hh)
#define pylith_meshio_datawriterhdf5databcmeshtri3_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataBCMeshTri3;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataBCMeshTri3 : public DataWriterData
{ // DataWriterHDF5DataBCMeshTri3

public: 

  /// Constructor
  DataWriterHDF5DataBCMeshTri3(void);
...
#endif // pylith_meshio_datawriterhdf5databcmeshtri3_hh
