...
#if !defined(pylith_meshio_datawriterhdf5datameshline2_hh)
#define pylith_meshio_datawriterhdf5datameshline2_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataMeshLine2;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataMeshLine2 : public DataWriterData
{ // DataWriterHDF5DataMeshLine2

public: 

  /// Constructor
  DataWriterHDF5DataMeshLine2(void);
...
#endif // pylith_meshio_datawriterhdf5datameshline2_hh
