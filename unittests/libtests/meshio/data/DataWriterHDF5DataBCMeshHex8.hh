...
#if !defined(pylith_meshio_datawriterhdf5databcmeshhex8_hh)
#define pylith_meshio_datawriterhdf5databcmeshhex8_hh

#include "DataWriterData.hh" // ISA DataWriterData

namespace pylith {
  namespace meshio {
     class DataWriterHDF5DataBCMeshHex8;
  } // meshio
} // pylith

class pylith::meshio::DataWriterHDF5DataBCMeshHex8 : public DataWriterData
{ // DataWriterHDF5DataBCMeshHex8

public: 

  /// Constructor
  DataWriterHDF5DataBCMeshHex8(void);
...
#endif // pylith_meshio_datawriterhdf5databcmeshhex8_hh
