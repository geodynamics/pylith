...
namespace pylith {
  namespace meshio {
    class TestDataWriterHDF5ExtSubMeshLine2;
...
class pylith::meshio::TestDataWriterHDF5ExtSubMeshLine2 : public TestDataWriterHDF5ExtSubMesh
{ // class TestDataWriterHDF5ExtSubMeshLine2

  // CPPUNIT TEST SUITE /////////////////////////////////////////////////
  CPPUNIT_TEST_SUITE( TestDataWriterHDF5ExtSubMeshLine2 );
