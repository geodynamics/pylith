...
namespace pylith {
  namespace meshio {
    class TestDataWriterHDF5ExtMeshLine2;
...
class pylith::meshio::TestDataWriterHDF5ExtMeshLine2 : public TestDataWriterHDF5ExtMesh
{ // class TestDataWriterHDF5ExtMeshLine2

  // CPPUNIT TEST SUITE /////////////////////////////////////////////////
  CPPUNIT_TEST_SUITE( TestDataWriterHDF5ExtMeshLine2 );
