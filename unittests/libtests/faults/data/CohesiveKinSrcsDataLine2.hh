...
#if !defined(pylith_faults_cohesivekindatasrcsline2_hh)
#define pylith_faults_cohesivekindatasrcsline2_hh

#include "CohesiveKinData.hh"

namespace pylith {
  namespace faults {
     class CohesiveKinSrcsDataLine2;
  } // pylith
} // faults

class pylith::faults::CohesiveKinSrcsDataLine2 : public CohesiveKinData
{
