...
#if !defined(pylith_faults_cohesivedatahex8e_hh)
#define pylith_faults_cohesivedatahex8e_hh

#include "CohesiveData.hh"

namespace pylith {
  namespace faults {
     class CohesiveDataHex8e;
  } // pylith
} // faults

class pylith::faults::CohesiveDataHex8e : public CohesiveData
{
...
#endif // pylith_faults_cohesivedatahex8e_hh
