...
#if !defined(pylith_faults_cohesivedatahex8f_hh)
#define pylith_faults_cohesivedatahex8f_hh

#include "CohesiveData.hh"

namespace pylith {
  namespace faults {
     class CohesiveDataHex8f;
  } // pylith
} // faults

class pylith::faults::CohesiveDataHex8f : public CohesiveData
{
...
#endif // pylith_faults_cohesivedatahex8f_hh
