...
#if !defined(pylith_faults_cohesivedatahex8b_hh)
#define pylith_faults_cohesivedatahex8b_hh

#include "CohesiveData.hh"

namespace pylith {
  namespace faults {
     class CohesiveDataHex8b;
  } // pylith
} // faults

class pylith::faults::CohesiveDataHex8b : public CohesiveData
{
...
#endif // pylith_faults_cohesivedatahex8b_hh
