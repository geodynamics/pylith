...
#if !defined(pylith_faults_cohesivedatahex8c_hh)
#define pylith_faults_cohesivedatahex8c_hh

#include "CohesiveData.hh"

namespace pylith {
  namespace faults {
     class CohesiveDataHex8c;
  } // pylith
} // faults

class pylith::faults::CohesiveDataHex8c : public CohesiveData
{
...
#endif // pylith_faults_cohesivedatahex8c_hh
