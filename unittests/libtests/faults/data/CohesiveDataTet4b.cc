...
const int pylith::faults::CohesiveDataTet4b::_numCorners[3] = {
  4,
  4,
  6
};

const int pylith::faults::CohesiveDataTet4b::_materialIds[3] = {
  0,  0,
  1
};
...
const int pylith::faults::CohesiveDataTet4b::_groupSizes[2] = {
  5+4+1, 6+6+2 // vertices+edges+faces
};

const char* pylith::faults::CohesiveDataTet4b::_groupNames[2] = {
  "output", "fault"
};

const char* pylith::faults::CohesiveDataTet4b::_groupTypes[2] = {
  "vertex", "vertex"
};
