...
#if !defined(pylith_faults_cohesivedatahex8d_hh)
#define pylith_faults_cohesivedatahex8d_hh

#include "CohesiveData.hh"

namespace pylith {
  namespace faults {
     class CohesiveDataHex8d;
  } // pylith
} // faults

class pylith::faults::CohesiveDataHex8d : public CohesiveData
{
...
#endif // pylith_faults_cohesivedatahex8d_hh
