...
var builds = function() {
    ...
    addMakeTarget(all, "run-libtests", ["check", "-C unittests/libtests"])
    addMakeTarget(all, "run-pytests", ["check", "-C unittests/pytests"])
    addMakeTarget(all, "run-fullscale", ["check", "-C tests_auto"])
