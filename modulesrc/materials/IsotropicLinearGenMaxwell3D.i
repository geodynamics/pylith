...
/** @file modulesrc/materials/IsotropicLinearGenMaxwell3D.i
 *
 * Python interface to C++ IsotropicLinearGenMaxwell3D.
 */

namespace pylith {
    namespace materials {

        class IsotropicLinearGenMaxwell3D : public Material { // class IsotropicLinearGenMaxwell3D
