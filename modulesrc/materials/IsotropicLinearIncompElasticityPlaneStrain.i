...
/** @file modulesrc/materials/IsotropicLinearIncompElasticityPlaneStrain.i
 *
 * Python interface to C++ IsotropicLinearIncompElasticityPlaneStrain.
 */

namespace pylith {
  namespace materials {

    class IsotropicLinearIncompElasticityPlaneStrain : public MaterialNew
