...
/** @file modulesrc/materials/IsotropicLinearMaxwellPlaneStrain.i
 *
 * Python interface to C++ IsotropicLinearMaxwellPlaneStrain.
 */

namespace pylith {
  namespace materials {

    class IsotropicLinearMaxwellPlaneStrain : public MaterialNew
