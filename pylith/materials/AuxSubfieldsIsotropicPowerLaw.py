...
class AuxSubfieldsIsotropicPowerLaw(PetscComponent):
    ...
    powerLawExponent = pythia.pyre.inventory.facility(
        "power_law_exponent", family="auxiliary_subfield", factory=Subfield)
    ...
    stress = pythia.pyre.inventory.facility(
        "stress", family="auxiliary_subfield", factory=Subfield)
