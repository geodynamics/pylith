...
class IsotropicLinearIncompElasticityPlaneStrain(MaterialNew, ModuleMaterial):
    ...
    def __init__(self, name="isotropiclinearincompelasticityplanestrain"):
        """
        Constructor.
        """
...
def material():
    """
    Factory associated with IsotropicLinearIncompElasticityPlaneStrain.
    """
    return IsotropicLinearIncompElasticityPlaneStrain()
