...
# @file pylith/materials/IsotropicLinearGenMaxwell3D.py
##
# @brief Python material for isotropic, linear generalized Maxwell viscoelastic,
# 3D material.
##
# Factory: material

from .Material import Material
from .materials import IsotropicLinearGenMaxwell3D as ModuleMaterial


class IsotropicLinearGenMaxwell3D(Material, ModuleMaterial):
    """
    Python material for isotropic, linear generalized Maxwell viscoelastic 3D.
    ...
    def __init__(self, name="isotropiclineargenmaxwell3d"):
        """
        Constructor.
        """
...
def material():
    """
    Factory associated with IsotropicLinearGenMaxwell3D.
    """
    return IsotropicLinearGenMaxwell3D()
