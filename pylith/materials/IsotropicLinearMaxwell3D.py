...
# @file pylith/materials/IsotropicLinearMaxwell3D.py
##
...
from .materials import IsotropicLinearMaxwell3D as ModuleMaterial


class IsotropicLinearMaxwell3D(Material, ModuleMaterial):
    """
    Python material for isotropic, linear Maxwell viscoelastic 3D.
    ...
    def __init__(self, name="isotropiclinearmaxwell3d"):
        """
        Constructor.
        """
...
def material():
    """
    Factory associated with IsotropicLinearMaxwell3D.
    """
    return IsotropicLinearMaxwell3D()
