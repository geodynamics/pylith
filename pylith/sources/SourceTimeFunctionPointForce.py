...
# ----------------------------------------------------------------------
#
# @file pylith/sources/SourceTimeFunctionPointForce.py
#
...
from .sources import SourceTimeFunctionPointForce as ModuleSourceTimeFunction


class SourceTimeFunctionPointForce(PetscComponent, ModuleSourceTimeFunction):
    """Python object for sourcetimefunction of a point source.
    ...
    def __init__(self, name):
        """Constructor.
        """
        PetscComponent.__init__(self, name, facility="sourcetimefunctionpointforce")
        return
    ...
    def preinitialize(self, problem):
        ...
        if 0 == comm.rank:
            self._info.log(
                "Performing minimal initialization of pointforce sourcetimefunction '%s'." % self.aliases[-1])
